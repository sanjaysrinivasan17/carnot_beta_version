...
export class AnalyticsComponent implements OnInit {
      ...
      this._http.getNewUserInfo().subscribe(info => {
        ...
        fetch(environment.api_name + 'api/project/get_project/' + project_id, {
          ...
          .then(data => {
            ...
            this.new_center = (data['data']['center'])
            // alert(this.new_center)
            localStorage.setItem("center", this.new_center);
            this.date_summary_status_key = Object.keys(data['data']["date_status"])
            this.date_summary_status_value = Object.values(data['data']["date_status"])
            ...
            this.Project_layer_summary_values = Object.values(this.main_data['processed_data'][this.datevalue]['summary_layers'])
            this.Project_layer_inverter_data = Object.keys(this.main_data['processed_data'][this.datevalue]['inverter_layers'])
            this.Project_layer_inverter_data_values = Object.values(this.main_data['processed_data'][this.datevalue]['inverter_layers'])
            this.health_history = Object.values(this.main_data['processed_data'][this.datevalue]['health_history'])
            this.health_history_key_data = Object.keys(this.main_data['processed_data'][this.datevalue]['health_history'])
            if (Object.keys(this.main_data['processed_data'][this.datevalue]['power_loss'])) {
              this.power_loss_keys = Object.keys(this.main_data['processed_data'][this.datevalue]['power_loss'])
              this.power_loss_values = Object.values(this.main_data['processed_data'][this.datevalue]['power_loss'])
              this.power_loss_values_energy = Object.values(this.main_data['processed_data'][this.datevalue]['power_loss'])
              this.power_loss_values_revenue = Object.values(this.main_data['processed_data'][this.datevalue]['power_loss'])
            }
            this.plant_capacity_datewise = (this.main_data['processed_data']['plant_capacity'])
            ...
            for (var p = 0; p < this.date_summary_status_key.length; p++) {
              ...
              if (year_array_date <= year) {
                ...
                this.health_history = Object.values(this.main_data['processed_data'][this.date_summary_status_key[p]]['health_history'])
                this.total_power_loss_dates.push(this.main_data['processed_data'][this.date_summary_status_key[p]]['total_power_loss'])
                new_defects = this.main_data['processed_data'][this.date_summary_status_key[p]]['total_no_defects']
                if (new_defects != 0) {
                  this.total_no_defects_dates.push(new_defects)
                  this.defects_dates.push([this.date_summary_status_key[p]])
                }
                this.health_history_keys = Object.keys(this.main_data['processed_data'][this.datevalue]['health_history'])
            ...
            this.resourcesLoaded = false;
            // Object.keys(this.main_data['processed_data'][this.datevalue]['inverter_layers'])
  ...
  selectChange(date) {
    ...
    this.Project_layer_summary = Object.keys(this.main_data['processed_data'][date]['summary_layers'])
    this.Project_layer_summary_values = Object.values(this.main_data['processed_data'][date]['summary_layers'])
    this.Project_layer_inverter_data_values = Object.values(this.main_data['processed_data'][date]['inverter_layers'])
    this.Project_layer_inverter_data = Object.keys(this.main_data['processed_data'][date]['inverter_layers'])
    this.health_history = Object.values(this.main_data['processed_data'][date]['health_history'])
    this.health_history_key_data = Object.keys(this.main_data['processed_data'][date]['health_history'])
    this.power_loss_keys = Object.keys(this.main_data['processed_data'][date]['power_loss'])
    this.power_loss_values = Object.values(this.main_data['processed_data'][date]['power_loss'])
    this.power_loss_values_energy = Object.values(this.main_data['processed_data'][date]['power_loss'])
    this.power_loss_values_revenue = Object.values(this.main_data['processed_data'][date]['power_loss'])
    this.plant_capacity_datewise = (this.main_data['processed_data']['plant_capacity'])
    this.total_power_loss_datewise = (this.main_data['processed_data'][date]['total_power_loss'])
    this.total_no_defects_datewise = (this.main_data['processed_data'][date]['total_no_defects'])
    this.total_module_count = (this.main_data['processed_data'][date]['total_modules_present'])
    ...
    this.inver_wise_data = Object.keys(this.main_data['processed_data'][date]['inverter_layers'])
    for (var i = 0; i < this.Project_layer_summary.length; i++) {
