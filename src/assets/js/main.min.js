!function(e, t) {
        ...
        typeCheckConfig: function(e, t, n) {
            for (var i in n)
                if (Object.prototype.hasOwnProperty.call(n, i)) {
                    var s = n[i]
                      , o = t[i]
                      , r = o && m.isElement(o) ? "element" : (a = o,
                    {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase());
                    if (!new RegExp(s).test(r))
                        throw new Error(e.toUpperCase() + ': Option "' + i + '" provided type "' + r + '" but expected type "' + s + '".')
                }
            var a
        },
    ...
    f(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', h._handleDismiss(new h)),
    f.fn[s] = h._jQueryInterface,
    f.fn[s].Constructor = h,
    ...
    var p = "button"
      ...
      , k = function() {
        ...
        return e.toggle = function() {
            ...
            if (n) {
                ...
                if (i) {
                    if ("radio" === i.type)
                        ...
                        "checkbox" === i.type ? "LABEL" === this._element.tagName && i.checked === this._element.classList.contains(b) && (e = !1) : e = !1;
                    e && (i.checked = !this._element.classList.contains(b),
                    f(i).trigger("change")),
                    i.focus(),
                    t = !1
                }
            ...
            e && f(this._element).toggleClass(b))
        }
        ,
        e.dispose = function() {
    ...
    f(document).on(E.CLICK_DATA_API, w, function(e) {
        var t = e.target;
        if (f(t).hasClass("btn") || (t = f(t).closest(T)[0]),
    ...
    f.fn[p] = k._jQueryInterface,
    f.fn[p].Constructor = k,
    ...
    var S = "carousel"
      ...
      , M = {
        ...
        LOAD_DATA_API: "load" + x + I,
        CLICK_DATA_API: "click" + x + I
    }
      , L = "active"
      ...
      , H = function() {
        ...
        e.to = function(e) {
            ...
            if (!(e > this._items.length - 1 || e < 0))
                if (this._isSliding)
                    f(this._element).one(M.SLID, function() {
                        return t.to(e)
                    });
                else {
                    if (n === e)
        ...
        e._addEventListeners = function() {
            var t = this;
            this._config.keyboard && f(this._element).on(M.KEYDOWN, function(e) {
                return t._keydown(e)
            }),
            "hover" === this._config.pause && f(this._element).on(M.MOUSEENTER, function(e) {
                return t.pause(e)
        ...
        e._addTouchEventListeners = function() {
            ...
            if (this._touchSupported) {
                var t = function(e) {
                  ...
                  , i = function(e) {
                    n._pointerEvent && q[e.originalEvent.pointerType.toUpperCase()] && (n.touchDeltaX = e.originalEvent.clientX - n.touchStartX),
                    n._handleSwipe(),
                ...
                f(this._element.querySelectorAll(".carousel-item img")).on(M.DRAG_START, function(e) {
                    return e.preventDefault()
                }),
                this._pointerEvent ? (f(this._element).on(M.POINTERDOWN, function(e) {
                    return t(e)
                }),
                f(this._element).on(M.POINTERUP, function(e) {
                    return i(e)
                }),
                this._element.classList.add("pointer-event")) : (f(this._element).on(M.TOUCHSTART, function(e) {
                    return t(e)
                }),
                f(this._element).on(M.TOUCHMOVE, function(e) {
                    var t;
                ...
                f(this._element).on(M.TOUCHEND, function(e) {
                    return i(e)
                }))
            }
        }
        ...
        e._getItemByDirection = function(e, t) {
            ...
            if ((i && 0 === s || n && s === o) && !this._config.wrap)
                return t;
            var r = (s + (e === N ? -1 : 1)) % this._items.length;
        ...
        e._triggerSlideEvent = function(e, t) {
            ...
            return f(this._element).trigger(s),
            s
        }
        ,
        ...
        e._slide = function(e, t) {
            var n, i, s, o = this, r = this._element.querySelector(j), a = this._getItemIndex(r), l = t || r && this._getItemByDirection(e, r), c = this._getItemIndex(l), u = Boolean(this._interval);
            if (s = e === P ? (n = "carousel-item-left",
            ...
            l && f(l).hasClass(L))
                ...
                if (f(this._element).hasClass("slide")) {
                    ...
                    f(r).one(m.TRANSITION_END, function() {
                        f(l).removeClass(n + " " + i).addClass(L),
                        f(r).removeClass(L + " " + i + " " + n),
                        o._isSliding = !1,
                        setTimeout(function() {
    ...
    f(document).on(M.CLICK_DATA_API, "[data-slide], [data-slide-to]", H._dataApiClickHandler),
    ...
    var R = "collapse"
      ...
      , X = function() {
        function a(t, e) {
            ...
            for (var n = [].slice.call(document.querySelectorAll(Z)), i = 0, s = n.length; i < s; i++) {
                var o = n[i]
        ...
        e.show = function() {
            var e, t, n = this;
            if (!(this._isTransitioning || f(this._element).hasClass(K) || (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(e) {
                return "string" == typeof n._config.parent ? e.getAttribute("data-parent") === n._config.parent : e.classList.contains(Q)
            })).length && (e = null),
            e && (t = f(e).not(this._selector).data(z)) && t._isTransitioning))) {
                var i = f.Event(V.SHOW);
                if (f(this._element).trigger(i),
                !i.isDefaultPrevented()) {
                    e && (a._jQueryInterface.call(f(e).not(this._selector), "hide"),
                    t || f(e).data(z, null));
                    var s = this._getDimension();
                    f(this._element).removeClass(Q).addClass(Y),
                    this._element.style[s] = 0,
                    this._triggerArray.length && f(this._triggerArray).removeClass(G).attr("aria-expanded", !0),
                    this.setTransitioning(!0);
                    var o = "scroll" + (s[0].toUpperCase() + s.slice(1))
                      , r = m.getTransitionDurationFromElement(this._element);
                    f(this._element).one(m.TRANSITION_END, function() {
                        f(n._element).removeClass(Y).addClass(Q).addClass(K),
                        n._element.style[s] = "",
                        n.setTransitioning(!1),
                        f(n._element).trigger(V.SHOWN)
        ...
        e.hide = function() {
            ...
            if (!this._isTransitioning && f(this._element).hasClass(K)) {
                var t = f.Event(V.HIDE);
                if (f(this._element).trigger(t),
                !t.isDefaultPrevented()) {
                    var n = this._getDimension();
                    this._element.style[n] = this._element.getBoundingClientRect()[n] + "px",
                    m.reflow(this._element),
                    f(this._element).addClass(Y).removeClass(Q).removeClass(K);
                    var i = this._triggerArray.length;
                    if (0 < i)
                        for (var s = 0; s < i; s++) {
                            var o = this._triggerArray[s]
                              , r = m.getSelectorFromElement(o);
                            null !== r && (f([].slice.call(document.querySelectorAll(r))).hasClass(K) || f(o).addClass(G).attr("aria-expanded", !1))
                        }
                    this.setTransitioning(!0),
                    ...
                    f(this._element).one(m.TRANSITION_END, function() {
                        ...
                        f(e._element).removeClass(Y).addClass(Q).trigger(V.HIDDEN)
        ...
        e._addAriaAndCollapsedClass = function(e, t) {
            var n = f(e).hasClass(K);
            t.length && f(t).toggleClass(G, !n).attr("aria-expanded", n)
        }
        ,
        ...
        a._jQueryInterface = function(i) {
            return this.each(function() {
                var e = f(this)
                  , t = e.data(z)
                  , n = l({}, U, {}, e.data(), {}, "object" == typeof i && i ? i : {});
    ...
    f(document).on(V.CLICK_DATA_API, Z, function(e) {
    ...
    f.fn[R] = X._jQueryInterface,
    f.fn[R].Constructor = X,
      ...
      , pe = function() {
        ...
        return e.toggle = function() {
            if (!this._element.disabled && !f(this._element).hasClass(re)) {
                var e = f(this._menu).hasClass(ae);
                c._clearMenus(),
                e || this.show(!0)
            }
        }
        ...
        e.show = function(e) {
            if (void 0 === e && (e = !1),
            !(this._element.disabled || f(this._element).hasClass(re) || f(this._menu).hasClass(ae))) {
                var t = {
                ...
                !n.isDefaultPrevented()) {
                    if (!this._inNavbar && e) {
                        ...
                        var s = this._element;
                        "parent" === this._config.reference ? s = i : m.isElement(this._config.reference) && (s = this._config.reference,
                        void 0 !== this._config.reference.jquery && (s = this._config.reference[0])),
                        "scrollParent" !== this._config.boundary && f(i).addClass("position-static"),
                        this._popper = new d(s,this._menu,this._getPopperConfig())
                    }
                    "ontouchstart"in document.documentElement && 0 === f(i).closest(".navbar-nav").length && f(document.body).children().on("mouseover", null, f.noop),
                    this._element.focus(),
                    this._element.setAttribute("aria-expanded", !0),
                    f(this._menu).toggleClass(ae),
                    f(i).toggleClass(ae).trigger(f.Event(oe.SHOWN, t))
                }
            }
        }
        ,
        e.hide = function() {
            if (!this._element.disabled && !f(this._element).hasClass(re) && f(this._menu).hasClass(ae)) {
                ...
                f(this._menu).toggleClass(ae),
                f(n).toggleClass(ae).trigger(f.Event(oe.HIDDEN, e)))
            }
        }
        ,
        e.dispose = function() {
            f.removeData(this._element, ee),
            f(this._element).off(te),
            this._element = null,
        ...
        e._addEventListeners = function() {
            var t = this;
            f(this._element).on(oe.CLICK, function(e) {
                e.preventDefault(),
                e.stopPropagation(),
                t.toggle()
            })
        ...
        ,
        e._getConfig = function(e) {
            return e = l({}, this.constructor.Default, {}, f(this._element).data(), {}, e),
            m.typeCheckConfig(J, e, this.constructor.DefaultType),
            e
        }
        ,
        ...
        e._getPlacement = function() {
            ...
            f(this._menu).hasClass(le) && (t = "top-end")) : e.hasClass("dropright") ? t = "right-start" : e.hasClass("dropleft") ? t = "left-start" : f(this._menu).hasClass(le) && (t = "bottom-end"),
            t
        }
        ,
        ...
        c._clearMenus = function(e) {
            if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                for (var t = [].slice.call(document.querySelectorAll(ce)), n = 0, i = t.length; n < i; n++) {
                    var s = c._getParentFromElement(t[n])
                      , o = f(t[n]).data(ee)
                      , r = {
                        relatedTarget: t[n]
                    };
                    ...
                    o) {
                        var a = o._menu;
                        if (f(s).hasClass(ae) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && f.contains(s, e.target))) {
                            var l = f.Event(oe.HIDE, r);
                            f(s).trigger(l),
                            l.isDefaultPrevented() || ("ontouchstart"in document.documentElement && f(document.body).children().off("mouseover", null, f.noop),
                            t[n].setAttribute("aria-expanded", "false"),
                            o._popper && o._popper.destroy(),
                            f(a).removeClass(ae),
                            f(s).removeClass(ae).trigger(f.Event(oe.HIDDEN, r)))
                        }
                    }
                }
        }
        ...
        c._dataApiKeydownHandler = function(e) {
            if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || f(e.target).closest(ue).length)) : se.test(e.which)) && (e.preventDefault(),
            e.stopPropagation(),
            !this.disabled && !f(this).hasClass(re))) {
    ...
    f(document).on(oe.KEYDOWN_DATA_API, ce, pe._dataApiKeydownHandler).on(oe.KEYDOWN_DATA_API, ue, pe._dataApiKeydownHandler).on(oe.CLICK_DATA_API + " " + oe.KEYUP_DATA_API, pe._clearMenus).on(oe.CLICK_DATA_API, ce, function(e) {
        e.preventDefault(),
        e.stopPropagation(),
        pe._jQueryInterface.call(f(this), "toggle")
    }).on(oe.CLICK_DATA_API, ".dropdown form", function(e) {
        e.stopPropagation()
    }),
    f.fn[J] = pe._jQueryInterface,
    f.fn[J].Constructor = pe,
      ...
      , Ae = function() {
        ...
        e.show = function(e) {
            ...
            if (!this._isShown && !this._isTransitioning) {
                ...
                f(this._element).on(be.CLICK_DISMISS, '[data-dismiss="modal"]', function(e) {
                    return t.hide(e)
                }),
                f(this._dialog).on(be.MOUSEDOWN_DISMISS, function() {
                    f(t._element).one(be.MOUSEUP_DISMISS, function(e) {
        ...
        e.hide = function(e) {
            ...
            this._isShown && !this._isTransitioning) {
                var n = f.Event(be.HIDE);
                if (f(this._element).trigger(n),
                this._isShown && !n.isDefaultPrevented()) {
                    this._isShown = !1;
                    var i = f(this._element).hasClass(Ce);
                    if (i && (this._isTransitioning = !0),
                    this._setEscapeEvent(),
                    this._setResizeEvent(),
                    f(document).off(be.FOCUSIN),
                    f(this._element).removeClass(Te),
                    f(this._element).off(be.CLICK_DISMISS),
                    f(this._dialog).off(be.MOUSEDOWN_DISMISS),
                    i) {
        ...
        e._triggerBackdropTransition = function() {
            ...
            if ("static" === this._config.backdrop) {
                var t = f.Event(be.HIDE_PREVENTED);
                if (f(this._element).trigger(t),
                t.defaultPrevented)
                    return;
        ...
        e._showElement = function(e) {
            var t = this
              , n = f(this._element).hasClass(Ce)
              , i = this._dialog ? this._dialog.querySelector(".modal-body") : null;
            function s() {
                t._config.focus && t._element.focus(),
                t._isTransitioning = !1,
                f(t._element).trigger(o)
            }
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element),
            this._element.style.display = "block",
            this._element.removeAttribute("aria-hidden"),
            this._element.setAttribute("aria-modal", !0),
            f(this._dialog).hasClass("modal-dialog-scrollable") && i ? i.scrollTop = 0 : this._element.scrollTop = 0,
            n && m.reflow(this._element),
            f(this._element).addClass(Te),
            this._config.focus && this._enforceFocus();
            var o = f.Event(be.SHOWN, {
                relatedTarget: e
            });
            if (n) {
        ...
        e._enforceFocus = function() {
            var t = this;
            f(document).off(be.FOCUSIN).on(be.FOCUSIN, function(e) {
        ...
        e._setEscapeEvent = function() {
            var t = this;
            this._isShown && this._config.keyboard ? f(this._element).on(be.KEYDOWN_DISMISS, function(e) {
                27 === e.which && t._triggerBackdropTransition()
            }) : this._isShown || f(this._element).off(be.KEYDOWN_DISMISS)
        }
        ,
        e._setResizeEvent = function() {
            var t = this;
            this._isShown ? f(window).on(be.RESIZE, function(e) {
                return t.handleUpdate(e)
            }) : f(window).off(be.RESIZE)
        }
        ,
        e._hideModal = function() {
            ...
            this._isTransitioning = !1,
            this._showBackdrop(function() {
                f(document.body).removeClass(we),
                e._resetAdjustments(),
                e._resetScrollbar(),
                f(e._element).trigger(be.HIDDEN)
            })
        }
        ,
        e._removeBackdrop = function() {
            this._backdrop && (f(this._backdrop).remove(),
            this._backdrop = null)
        }
        ,
        e._showBackdrop = function(e) {
            var t = this
              , n = f(this._element).hasClass(Ce) ? Ce : "";
            if (this._isShown && this._config.backdrop) {
                if (this._backdrop = document.createElement("div"),
                this._backdrop.className = "modal-backdrop",
                n && this._backdrop.classList.add(n),
                f(this._backdrop).appendTo(document.body),
                f(this._element).on(be.CLICK_DISMISS, function(e) {
                    t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && t._triggerBackdropTransition()
                }),
                n && m.reflow(this._backdrop),
                f(this._backdrop).addClass(Te),
                !e)
                    return;
                if (!n)
                    return void e();
                ...
                f(this._backdrop).removeClass(Te);
                var s = function() {
                    t._removeBackdrop(),
                    e && e()
                };
        ...
        e._setScrollbar = function() {
            ...
            if (this._isBodyOverflowing) {
                ...
                f(e).each(function(e, t) {
                    ...
                    f(t).data("padding-right", n).css("padding-right", parseFloat(i) + s._scrollbarWidth + "px")
                }),
                f(t).each(function(e, t) {
                    var n = t.style.marginRight
                      , i = f(t).css("margin-right");
                    f(t).data("margin-right", n).css("margin-right", parseFloat(i) - s._scrollbarWidth + "px")
                });
        ...
        s._jQueryInterface = function(n, i) {
            return this.each(function() {
                var e = f(this).data(me)
                  , t = l({}, ye, {}, f(this).data(), {}, "object" == typeof n && n ? n : {});
                if (e || (e = new s(this,t),
                f(this).data(me, e)),
                "string" == typeof n) {
                    if (void 0 === e[n])
    ...
    f(document).on(be.CLICK_DATA_API, '[data-toggle="modal"]', function(e) {
        var t, n = this, i = m.getSelectorFromElement(this);
        i && (t = document.querySelector(i));
        var s = f(t).data(me) ? "toggle" : l({}, f(t).data(), {}, f(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
        var o = f(t).one(be.SHOW, function(e) {
            e.isDefaultPrevented() || o.one(be.HIDDEN, function() {
                f(n).is(":visible") && n.focus()
            })
        });
        Ae._jQueryInterface.call(f(t), s, this)
    }),
    f.fn[fe] = Ae._jQueryInterface,
    f.fn[fe].Constructor = Ae,
    ...
    function De(e, o, t) {
        ...
        if (t && "function" == typeof t)
            return t(e);
        for (var n = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(o), a = [].slice.call(n.body.querySelectorAll("*")), i = function(e) {
            var t = a[e]
            ...
            i.forEach(function(e) {
                !function(e, t) {
                    ...
                    if (-1 !== t.indexOf(n))
                        return -1 === xe.indexOf(n) || Boolean(e.nodeValue.match(Ie) || e.nodeValue.match($e));
                    for (var i = t.filter(function(e) {
                        ...
                        if (n.match(i[s]))
                            return !0;
                    return !1
                }(e, s) && t.removeAttribute(e.nodeName)
            })
      ...
      , Qe = function() {
        ...
        e.toggle = function(e) {
            if (this._isEnabled)
                if (e) {
                    ...
                    if (f(this.getTipElement()).hasClass(We))
        ...
        e.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                this.setContent(),
                this.config.animation && f(s).addClass(Ue);
                ...
                this._popper = new d(this.element,s,this._getPopperConfig(a)),
                f(s).addClass(We),
                ...
                var c = function() {
                    ...
                    var e = t._hoverState;
                    t._hoverState = null,
                    f(t.element).trigger(t.constructor.Event.SHOWN),
        ...
        e.hide = function(e) {
            ...
            if (f(this.element).trigger(s),
            !s.isDefaultPrevented()) {
                if (f(i).removeClass(We),
                ...
                f(this.tip).hasClass(Ue)) {
                    ...
                    f(i).one(m.TRANSITION_END, t).emulateTransitionEnd(o)
                } else
                    t();
                this._hoverState = ""
            }
        ...
        e.addAttachmentClass = function(e) {
            f(this.getTipElement()).addClass(Le + "-" + e)
        }
        ,
        ...
        e.setContent = function() {
            ...
            this.setElementContent(f(e.querySelectorAll(".tooltip-inner")), this.getTitle()),
            f(e).removeClass(Ue + " " + We)
        }
        ,
        e.setElementContent = function(e, t) {
            "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = De(t, this.config.whiteList, this.config.sanitizeFn)),
            e.html(t)) : e.text(t) : this.config.html ? f(t).parent().is(e) || e.empty().append(t) : e.text(f(t).text())
        }
        ,
        e.getTitle = function() {
        ...
        e._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(e) {
                if ("click" === e)
                    ...
                    var t = e === Ve ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN
                      , n = e === Ve ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
        ...
        e._enter = function(e, t) {
            ...
            (t = t || f(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget,this._getDelegateConfig()),
            f(e.currentTarget).data(n, t)),
            e && (t._activeTrigger["focusin" === e.type ? Ke : Ve] = !0),
            f(t.getTipElement()).hasClass(We) || t._hoverState === Fe ? t._hoverState = Fe : (clearTimeout(t._timeout),
            t._hoverState = Fe,
        ...
        e._getConfig = function(e) {
            ...
            e.sanitize && (e.template = De(e.template, e.whiteList, e.sanitizeFn)),
            e
        }
        ,
        ...
        e._fixTransition = function() {
            ...
            null === e.getAttribute("x-placement") && (f(e).removeClass(Ue),
    ...
    f.fn[Oe] = Qe._jQueryInterface,
    f.fn[Oe].Constructor = Qe,
    ...
    var Ye = "popover"
      ...
      , st = function(e) {
        ...
        s.addAttachmentClass = function(e) {
            f(this.getTipElement()).addClass(Je + "-" + e)
        }
        ,
    ...
    f.fn[Ye] = st._jQueryInterface,
    f.fn[Ye].Constructor = st,
    f.fn[Ye].noConflict = function() {
        return f.fn[Ye] = Xe,
        st._jQueryInterface
    }
    ;
    var ot = "scrollspy"
      ...
      , vt = function() {
        function n(e, t) {
            ...
            this._config = this._getConfig(t),
            this._selector = this._config.target + " " + ft + "," + this._config.target + " " + mt + "," + this._config.target + " .dropdown-item",
            this._offsets = [],
            this._targets = [],
            this._activeTarget = null,
            this._scrollHeight = 0,
            f(this._scrollElement).on(dt.SCROLL, function(e) {
                return n._process(e)
            }),
            this.refresh(),
            this._process()
        ...
        ,
        e._getConfig = function(e) {
            if ("string" != typeof (e = l({}, ct, {}, "object" == typeof e && e ? e : {})).target) {
                var t = f(e.target).attr("id");
                t || (t = m.getUID(ot),
                f(e.target).attr("id", t)),
                e.target = "#" + t
            }
            return m.typeCheckConfig(ot, e, ut),
            e
        }
        ,
        ...
        e._activate = function(t) {
            ...
            n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(ht),
            n.addClass(ht)) : (n.addClass(ht),
            n.parents(pt).prev(ft + ", " + mt).addClass(ht),
            n.parents(pt).prev(".nav-item").children(ft).addClass(ht)),
            f(this._scrollElement).trigger(dt.ACTIVATE, {
                relatedTarget: t
            })
        }
        ,
    ...
    f(window).on(dt.LOAD_DATA_API, function() {
        for (var e = [].slice.call(document.querySelectorAll('[data-spy="scroll"]')), t = e.length; t--; ) {
            var n = f(e[t]);
            vt._jQueryInterface.call(n, n.data())
        }
    }),
    f.fn[ot] = vt._jQueryInterface,
    f.fn[ot].Constructor = vt,
    ...
    var yt = "bs.tab"
      ...
      , kt = function() {
        ...
        return e.show = function() {
            var n = this;
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && f(this._element).hasClass(Ct) || f(this._element).hasClass("disabled"))) {
                var e, i, t = f(this._element).closest(".nav, .list-group")[0], s = m.getSelectorFromElement(this._element);
                if (t) {
                    var o = "UL" === t.nodeName || "OL" === t.nodeName ? Et : Tt;
                    i = (i = f.makeArray(f(t).find(o)))[i.length - 1]
                }
                var r = f.Event(wt.HIDE, {
                    relatedTarget: this._element
                })
                  , a = f.Event(wt.SHOW, {
                    relatedTarget: i
        ...
        e._activate = function(e, t, n) {
            ...
            var s = this
              , o = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? f(t).children(Tt) : f(t).find(Et))[0]
              , r = n && o && f(o).hasClass("fade");
            if (o && r) {
                var a = m.getTransitionDurationFromElement(o);
                f(o).removeClass("show").one(m.TRANSITION_END, i).emulateTransitionEnd(a)
            } else
                i()
        }
        ,
        e._transitionComplete = function(e, t, n) {
            if (t) {
                f(t).removeClass(Ct);
                var i = f(t.parentNode).find("> .dropdown-menu .active")[0];
                i && f(i).removeClass(Ct),
    ...
    f(document).on(wt.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(e) {
        e.preventDefault(),
        kt._jQueryInterface.call(f(this), "show")
    }),
    f.fn.tab = kt._jQueryInterface,
    f.fn.tab.Constructor = kt,
    ...
    var St = "toast"
      ...
      , Mt = function() {
        ...
        return e.show = function() {
            ...
            !t.isDefaultPrevented()) {
                ...
                this._config.animation) {
                    ...
                    f(this._element).one(m.TRANSITION_END, n).emulateTransitionEnd(i)
                } else
                    n()
            }
        }
        ...
        e.dispose = function() {
            ...
            f.removeData(this._element, At),
            this._element = null,
            this._config = null
        }
        ,
        e._getConfig = function(e) {
            return e = l({}, Nt, {}, f(this._element).data(), {}, "object" == typeof e && e ? e : {}),
            m.typeCheckConfig(St, e, this.constructor.DefaultType),
            e
        }
        ,
        e._setListeners = function() {
            var e = this;
            f(this._element).on($t.CLICK_DISMISS, '[data-dismiss="toast"]', function() {
                return e.hide()
            })
        }
        ,
    ...
    f.fn[St] = Mt._jQueryInterface,
    f.fn[St].Constructor = Mt,
...
, function(e, t, n) {
    ...
    var i = {
        init: function(e, t) {
            ...
            e.addClass("nav-side-icon"),
            t.toggleHoverSidebar && ($(".core-nav").stop().on("mouseenter", function() {
...
, function(e, t, n) {
    ...
    var i = {
        ...
        setPosition: function() {
            var e = $(".core-nav-list")
              , t = e.outerHeight() / 2;
            920 < $(window).width() ? (e.css("margin-top", -1 * t),
            e.css("top", .5 * $(window).height())) : (e.css("margin-top", 0),
            e.css("top", 0))
        }
    };
    e.exports = i
...
, function(e, t, n) {
    ...
    var i = {
        init: function(e, t) {
            ...
            e.addClass("sidebar-toggle"),
            this.layout(t),
            $(window).on("resize", function() {
                n.layout(t)
            }),
            t.menuFullWidth && $(".wrap-core-nav-list").addClass("full-width")
        },
        layout: function(e) {
            var t = $(window).width()
              , n = $(".core-nav-toggle")
              , i = n.height() / 2;
            if (920 < t) {
                if (n.css("margin-top", "-" + i + "px"),
                e.menuFullWidth) {
                    var s = $(".core-nav-list > li").length
                      , o = (t - $(".sidebar-toggle").width()) / s;
                    $(".core-nav-list > li").css("width", o - .5 + "px")
                }
            } else
                n.css("margin-top", ""),
                $(".core-nav-list > li").css("width", "")
        }
    };
    e.exports = i
}
, function(e, t, n) {
    ...
    var i = {
        init: function(e, t) {
            $(".core-content").addClass("core-sidebar"),
            e.addClass("nav-sidebar")
        }
    };
    e.exports = i
}
, function(e, t, n) {
    ...
    var i = {
        init: function(t, e) {
            ...
            var n = $(".core-nav-toggle").html();
            $(".wrap-core-nav-list > .nav-container").prepend('<button class="toggle-bar core-nav-toggle">' + n + "</button>"),
            $(".core-nav-toggle").on("click", function(e) {
                e.preventDefault(),
                t.toggleClass("open-fullscreen"),
...
, function(e, t, n) {
    ...
    var i = {
        init: function(e, t) {
            t.container ? e.wrapInner("<div class='nav-container'></div>") : e.wrapInner("<div class='full-container'></div>"),
            $(".core-nav-list").addClass("split-list"),
            this.devidedMenu(t)
        },
        devidedMenu: function(e) {
            var t = $(".split-list");
            t.each(function() {
                for (var e = new Array, t = $(".split-list > li"), n = Math.floor(t.length / 2), i = t.length - 2 * n, s = 0; s < 2; s++)
                    e[s] = s < i ? n + 1 : n;
                for (s = 0; s < 2; s++) {
                    ...
                    for (var o = 0; o < e[s]; o++) {
                        for (var r = 0, a = 0; a < s; a++)
                            r += e[a];
                        $(".wrap-core-nav-list").find(".core-nav-list").last().append(t[o + r])
                    }
                }
            }),
            t.remove(),
...
, function(e, t, n) {
    ...
    var y = n(2)
      ...
      , w = Math.max
      , C = Math.min;
    e.exports = function(i, s, e) {
        var o, r, n, a, l, c, u = 0, d = !1, h = !1, t = !0;
        ...
        function f(e) {
            var t = e - c;
            return void 0 === c || s <= t || t < 0 || h && n <= e - u
        }
        function m() {
            var e, t = _();
            if (f(t))
                return g(t);
            l = setTimeout(m, (e = s - (t - c),
            h ? C(e, n - (t - u)) : e))
        }
        function g(e) {
            return l = void 0,
        ...
        function v() {
            ...
            n) {
                if (void 0 === l)
                    ...
                    d ? p(e) : a;
                if (h)
                    return l = setTimeout(m, s),
                    p(c)
            }
            return void 0 === l && (l = setTimeout(m, s)),
            a
        }
        return s = b(s) || 0,
        y(e) && (d = !!e.leading,
        n = (h = "maxWait"in e) ? w(b(e.maxWait) || 0, s) : n,
...
, function(i, e, t) {
    ...
    (function(e) {
        ...
        : function(e) {
          ...
          , n = "object" == (void 0 === e ? "undefined" : t(e)) && e && e.Object === Object && e;
        i.exports = n
    }
    ).call(this, t(15))
}
...
, function(e, t, n) {
    ...
    : function(e) {
      ...
      , o = n(12);
    e.exports = function(e) {
        return "symbol" == (void 0 === e ? "undefined" : i(e)) || o(e) && "[object Symbol]" == s(e)
    }
}
, function(e, t, n) {
    "use strict";
    var i = n(3);
    e.exports = function(e) {
        return e ? (e = i(e)) === 1 / 0 || e === -1 / 0 ? 17976931348623157e292 * (e < 0 ? -1 : 1) : e == e ? e : 0 : 0 === e ? e : 0
    }
}
, function(e, t, n) {
    "use strict";
...
, function(e, t, n) {
    ...
    var r = {
        init: function(e, t) {
            var n = this;
            if (e.addClass("core-nav"),
            $(".core-nav").removeAttr("hidden"),
            $(".core-content").length || $("body").wrapInner('<div class="core-content"></div>'),
            $(t.menu).addClass("core-nav-list"),
            $(t.toggleMenu).addClass("core-nav-toggle"),
            $(t.menu).wrap('<div class="wrap-core-nav-list"></div>'),
            $(".wrap-core-nav-list, .nav-header").addClass(t.menuPosition),
            "default" == t.layout)
                switch (t.menuPosition) {
                case "bottom":
                    t.container ? ($(".wrap-core-nav-list").wrapInner("<div class='nav-container'></div>"),
                    $(t.header).wrapInner("<div class='nav-container'></div>")) : ($(".wrap-core-nav-list").wrapInner("<div class='full-container'></div>"),
                    $(t.header).wrapInner("<div class='full-container'></div>"));
                    break;
                case "bottom center":
                    t.container ? ($(".wrap-core-nav-list").wrapInner("<div class='nav-container center'></div>"),
                    $(t.header).wrapInner("<div class='nav-container center'></div>")) : ($(".wrap-core-nav-list").wrapInner("<div class='full-container center'></div>"),
                    $(t.header).wrapInner("<div class='full-container center'></div>"));
                    break;
                case "bottom right":
                    t.container ? ($(".wrap-core-nav-list").wrapInner("<div class='nav-container right'></div>"),
                    $(t.header).wrapInner("<div class='nav-container'></div>")) : ($(".wrap-core-nav-list").wrapInner("<div class='full-container right'></div>"),
                    $(t.header).wrapInner("<div class='full-container'></div>"));
                    break;
                default:
                    t.container ? e.wrapInner("<div class='nav-container'></div>") : e.wrapInner("<div class='full-container'></div>")
                }
            t.responsideSlide && $(".core-content").addClass("core-responsive-slide"),
            n.attributesIcon(t),
            n.toggleMenu(e),
            n.megaMenu(t, ".core-nav-list .megamenu"),
            n.dropddownMenu(t, ".core-nav-list .dropdown"),
            $(".dropdown-overlay").on("click", function(e) {
                ...
                $.isFunction(t.onCloseDropdown) && t.onCloseDropdown(),
            ...
            this.scrollSpy(t),
            n.contentHeader(t),
            $.isFunction(t.onInit) && t.onInit(),
            $(window).on("resize", (0,
            s.default)(function() {
                n.contentHeader(t),
                n.attributesIcon(t),
                $.isFunction(t.onResize) && t.onResize()
            }, 1e3))
        },
        setMode: function(e) {
            switch (e.mode) {
            ...
            case "sticky":
                ...
                $('<div class="stand-sticky"></div>').insertBefore(".core-nav"),
                $(".stand-sticky").css("height", $(".core-nav").height()),
                $(".stand-sticky").css("display", "none");
                var t = $(".nav-core-sticky").offset().top;
                $(window).on("resize", function() {
                    $(".stand-sticky").css("height", $(".core-nav").height())
                }),
                $(window).on("scroll", function() {
                    $(window).scrollTop() > t ? ($(".nav-core-sticky").hasClass("on-scroll") || $.isFunction(e.onStartSticky) && e.onStartSticky(),
                    $(".nav-core-sticky").addClass("on-scroll"),
                    $(".stand-sticky").css("display", "block")) : ($(".nav-core-sticky").hasClass("on-scroll") && $.isFunction(e.onEndSticky) && e.onEndSticky(),
        ...
        topSearch: function(e) {
            var t = $(".wrap-search-top")
              , n = t.html();
            t.length && (t.remove(),
            $(".core-nav").prepend('<div class="wrap-search-top">' + n + "</div>")),
            e.container ? $(".wrap-search-top").wrapInner("<div class='nav-container'></div>") : $(".wrap-search-top").wrapInner("<div class='full-container'></div>"),
            $(".toggle-search-top").on("click", function(e) {
                e.preventDefault(),
                $(".wrap-search-top").slideToggle()
            }),
            $(window).on("resize", function() {
                (0,
                i.default)(function() {
        ...
        contentHeader: function(e) {
            var t = $(".content-header").html()
              , n = $(window).width();
            if ($(".content-header").length && "default" == e.layout)
                switch (e.menuPosition) {
                case "bottom":
                    992 < n ? (e.container ? $(".nav-header .nav-container").prepend("<div class='content-header'>" + t + "</div>") : $(".nav-header .full-container").prepend("<div class='content-header'>" + t + "</div>"),
                    $(".core-nav > .content-header").remove()) : ($(".content-header").remove(),
                    $(".core-nav").prepend("<div class='content-header'>" + t + "</div>"))
                }
        },
        fullScreenSearch: function() {
            $(".wrap-search-fullscreen").wrapInner("<div class='nav-container'></div>"),
            $(".toggle-search-fullscreen").on("click", function(e) {
                e.preventDefault(),
                $(".wrap-search-fullscreen").addClass("open")
            }),
            $(window).on("resize", function() {
                (0,
                i.default)(function() {
            ...
            $(".close-search").on("click", function(e) {
                e.preventDefault(),
                $(".wrap-search-fullscreen").removeClass("open")
            })
        },
        toggleMenu: function(t) {
            $(".core-nav-toggle").on("click", function(e) {
                e.preventDefault(),
                t.toggleClass("open-responsive"),
                $(".core-responsive-slide").length && $(".core-responsive-slide").toggleClass("open"),
                $(".open-responsive").length ? ($(".dropdown-overlay").addClass("open-dropdown"),
                $(".core-nav").addClass("open-dropdown"),
                $(".core-nav .attributes .megamenu").removeClass("open"),
                $(".core-nav .attributes .dropdown").removeClass("open")) : ($(".dropdown-overlay").removeClass("open-dropdown"),
                $(".core-nav").removeClass("open-dropdown")),
                $(".wrap-search-top").slideUp()
            })
        },
        megaMenu: function(i, e) {
            $(".dropdown-overlay").length || $(".core-nav").after('<div class="dropdown-overlay"></div>'),
            $(e).each(function() {
                var t = $(this)
                  , e = $(this).find("a").eq(0)
                  , n = $(this).data("width");
                switch (null != n && ($(this).css("position", "relative"),
                $(this).find(".megamenu-content").eq(0).css("width", n)),
                t.removeClass("open"),
                e.on("click", function(e) {
                    e.preventDefault(),
                    $(window).width() < 920 && (t.hasClass("open") ? (i.animated ? r.animateCss(t.find(".megamenu-content").eq(0), i, i.animatedOut, !1, function() {
                        setTimeout(function() {
                            t.removeClass("open")
                        }, 500)
                    }) : t.removeClass("open"),
                    $.isFunction(i.onCloseMegaMenu) && i.onCloseMegaMenu()) : ($(".megamenu").removeClass("open"),
                    i.animated ? (t.addClass("open"),
                    r.animateCss(t.find(".megamenu-content").eq(0), i, i.animatedIn, !0)) : t.addClass("open"),
                    $.isFunction(i.onOpenMegaMenu) && i.onOpenMegaMenu())),
                    r.overlayDropdown()
                }),
                i.dropdownEvent) {
                case "hover":
                    e.on("mouseenter", function(e) {
                        920 < $(window).width() && (i.animated ? (t.addClass("open"),
                        r.animateCss(t.find(".megamenu-content").eq(0), i, i.animatedIn, !0)) : t.addClass("open")),
                        r.overlayDropdown(),
                        $.isFunction(i.onOpenMegaMenu) && i.onOpenMegaMenu()
                    }),
                    t.stop().on("mouseleave", function() {
                        920 < $(window).width() && (i.animated ? r.animateCss(t.find(".megamenu-content").eq(0), i, i.animatedOut, !1, function() {
                            setTimeout(function() {
                                t.removeClass("open")
                            }, 500)
                        }) : t.removeClass("open")),
                        r.overlayDropdown(),
                        $.isFunction(i.onCloseMegaMenu) && i.onCloseMegaMenu()
                    });
                    break;
                case "accordion":
                case "click":
                    e.on("click", function(e) {
                        e.preventDefault(),
                        920 < $(window).width() && (t.hasClass("open") ? (i.animated ? r.animateCss(t.find(".megamenu-content").eq(0), i, i.animatedOut, !1, function() {
                            setTimeout(function() {
                                t.removeClass("open")
                            }, 500)
                        }) : t.removeClass("open"),
                        $.isFunction(i.onCloseMegaMenu) && i.onCloseMegaMenu()) : (t.closest("li").closest("ul").find(".open").removeClass("open"),
                        i.animated ? (t.addClass("open"),
                        r.animateCss(t.find(".megamenu-content").eq(0), i, i.animatedIn, !0)) : t.addClass("open"),
                        $.isFunction(i.onOpenMegaMenu) && i.onOpenMegaMenu())),
                        r.overlayDropdown()
        ...
        dropddownMenu: function(n, e) {
            ...
            $(e).each(function() {
                var t = $(this)
                  , e = $(this).find("a").eq(0);
                switch (t.removeClass("open"),
                e.on("click", function(e) {
                    e.preventDefault(),
                    $(window).width() < 920 && (t.hasClass("open") ? (n.animated ? r.animateCss(t.find(".dropdown-menu").eq(0), n, n.animatedOut, !1, function() {
                        setTimeout(function() {
                            t.removeClass("open")
                        }, 500)
                    }) : t.removeClass("open"),
                    $.isFunction(n.onCloseDropdown) && n.onCloseDropdown()) : (n.animated ? (t.addClass("open"),
                    r.animateCss(t.find(".dropdown-menu").eq(0), n, n.animatedIn, !0)) : t.addClass("open"),
                ...
                case "hover":
                    e.on("mouseenter", function(e) {
                        920 < $(window).width() && (n.animated ? (t.addClass("open"),
                        r.animateCss(t.find(".dropdown-menu").eq(0), n, n.animatedIn, !0)) : t.addClass("open"),
                        $.isFunction(n.onOpenDropdown) && n.onOpenDropdown()),
                        r.overlayDropdown()
                    }),
                    t.stop().on("mouseleave", function() {
                        920 < $(window).width() && (n.animated ? r.animateCss(t.find(".dropdown-menu").eq(0), n, n.animatedOut, !1, function() {
                            setTimeout(function() {
                                t.removeClass("open")
                            }, 500)
                        }) : t.removeClass("open"),
                ...
                case "click":
                    e.on("click", function(e) {
                        e.preventDefault(),
                        920 < $(window).width() && (t.hasClass("open") ? (n.animated ? r.animateCss(t.find(".dropdown-menu").eq(0), n, n.animatedOut, !1, function() {
                            setTimeout(function() {
                                t.removeClass("open")
                            }, 500)
                        }) : t.removeClass("open"),
                        $.isFunction(n.onCloseDropdown) && n.onCloseDropdown()) : (t.closest("li").closest("ul").find(".open").removeClass("open"),
                        n.animated ? (t.addClass("open"),
                        r.animateCss(t.find(".dropdown-menu").eq(0), n, n.animatedIn, !0)) : t.addClass("open"),
                        $.isFunction(n.onOpenDropdown) && n.onOpenDropdown())),
                        r.overlayDropdown()
                    });
        ...
        overlayDropdown: function() {
            var e = $(".dropdown").hasClass("open")
              , t = $(".megamenu").hasClass("open");
            e || t ? ($(".dropdown-overlay").addClass("open-dropdown"),
            $(".core-nav").addClass("open-dropdown")) : ($(".dropdown-overlay").removeClass("open-dropdown"),
            $(".core-nav").removeClass("open-dropdown"))
        },
        attributesIcon: function(e) {
            var t = $(window).width()
              , n = $(".core-nav .attributes")
              , i = n.length
              , s = n.html();
            if (i) {
                switch (e.menuPosition) {
                ...
                case "bottom right":
                case "bottom":
                    e.container ? 992 < t && ($(".core-nav .nav-container").prepend('<ul class="attributes">' + s + "</ul>"),
                    $(".nav-header .attributes").remove()) : 992 < t && ($(".core-nav .full-container").prepend('<ul class="attributes">' + s + "</ul>"),
                    $(".nav-header .attributes").remove());
                    break;
                default:
                    e.container,
                    992 < t && ($(".core-nav .wrap-core-nav-list").prepend('<ul class="attributes">' + s + "</ul>"),
                    $(".nav-header .attributes").remove())
                }
                "sidebar" == e.layout && 992 < t && $(".core-nav").prepend('<ul class="attributes">' + s + "</ul>"),
                t < 992 && ($(".nav-header").prepend('<ul class="attributes">' + s + "</ul>"),
                $(".wrap-core-nav-list .attributes").remove(),
                $(".core-nav .attributes").find(".dropdown").each(function() {
                    var e = $(this).width()
                      , t = -1 * $(".dropdown-menu", this).width();
                    $(".dropdown-menu", this).css("marginLeft", t + e)
                }),
                $(".core-nav .attributes").find(".megamenu").each(function() {
                    var e = $(this).width()
                      , t = -1 * $(".megamenu-content", this).width();
                    $(".megamenu-content", this).css("marginLeft", t + e)
                })),
                n.remove(),
                this.megaMenu(e, ".attributes .megamenu"),
                this.dropddownMenu(e, ".attributes .dropdown"),
        ...
        scrollSpy: function(s) {
            $(".scrollspy").each(function() {
                ...
                $(i).length && $(window).on("scroll", function() {
                    var e;
                    e = "section" == s.layout && 920 < $(window).width() ? $(i).offset().top : $(i).offset().top - parseInt($(i).css("padding-top")),
                    $(window).scrollTop() > e - 1 || $(window).scrollTop() > e + 1 ? ($(".scrollspy").removeClass("active"),
                    $(t).addClass("active")) : $(t).removeClass("active")
                }),
                $("a", this).on("click", function(e) {
                    e.preventDefault();
                    var t, n = $("html, body");
                    t = "section" == s.layout && 920 < $(window).width() ? $(i).offset().top + 1 : $(i).offset().top - parseInt($(i).css("padding-top")) / 2,
                    n.stop().animate({
                        scrollTop: t
                    }, 500)
                })
        ...
        animateCss: function(e, t, n, i, s) {
            e.removeClass("animated"),
            i ? e.removeClass(t.animatedOut) : e.removeClass(t.animatedIn),
            e.addClass("animated " + n),
            "function" == typeof s && s()
        }
    };
    e.exports = r
...
, function(e, t, n) {
    "use strict";
    var i, s = d(n(23)), o = d(n(9)), r = d(n(8)), a = d(n(7)), l = d(n(6)), c = d(n(5)), u = d(n(4));
    function d(e) {
        return e && e.__esModule ? e : {
            default: e
        }
    }
    (i = jQuery).fn.coreNavigation = function(e) {
        var t = i.extend({
            layout: "default",
            menu: ".menu",
            menuFullWidth: !1,
        ...
        switch (s.default.init(this, t),
        t.layout) {
        case "brand-center":
            o.default.init(this, t);
            break;
        case "fullscreen":
            r.default.init(this, t);
            break;
        case "sidebar":
            a.default.init(this, t);
            break;
        case "sidebar-toggle":
            l.default.init(this, t);
            break;
        case "section":
            c.default.init(this, t);
            break;
        case "side-icon":
            u.default.init(this, t)
        }
    }
}
]),
                ...
                [].forEach.call(n, function(l) {
                    l.addEventListener("click", function(e) {
                        ...
                        var t = l.dataset.videoId
                          , n = l.dataset.channel || u.channel
                          , i = (0,
                        f.getUniqId)()
                          , s = l.dataset.videoUrl || c.getVideoUrl(u, n, t)
                          , o = c.getHtml(u, s, i);
                        (0,
                        f.append)(d, o);
                        var r = document.getElementById(i)
                          , a = r.querySelector(".js-modal-video-dismiss-btn");
                        r.focus(),
                        r.addEventListener("click", function() {
                            (0,
                            f.addClass)(r, h.modalVideoClose),
                            setTimeout(function() {
                                (0,
                                f.remove)(r),
                                l.focus()
                        ...
                        r.addEventListener("keydown", function(e) {
                            ...
                            document.activeElement === r ? a.focus() : (r.setAttribute("aria-label", ""),
                            r.focus()))
                        }),
                        a.addEventListener("click", function() {
                            (0,
                            f.triggerEvent)(r, "click")
                        })
                    })
                })
            }
...
function(e) {
    ...
    var d, i, h, s, p, t, l = "Close", c = "BeforeClose", f = "MarkupParse", m = "Open", g = ".mfp", v = "mfp-ready", n = "mfp-removing", r = "mfp-prevent-close", e = function() {}, a = !!window.jQuery, y = u(window), _ = function(e, t) {
        d.ev.on("mfp" + e + g, t)
    }, b = function(e, t, n, i) {
        var s = document.createElement("div");
        return s.className = "mfp-" + e,
        n && (s.innerHTML = n),
        i ? t && t.appendChild(s) : (s = u(s),
        t && s.appendTo(t)),
        s
    }, w = function(e, t) {
    ...
    e.prototype = {
        ...
        open: function(e) {
            ...
            if (!d.isOpen) {
                ...
                d.bgOverlay || (d.bgOverlay = b("bg").on("click" + g, function() {
                    d.close()
                }),
                ...
                w("BeforeOpen"),
                d.st.showCloseBtn && (d.st.closeBtnInside ? (_(f, function(e, t, n, i) {
        ...
        updateItemHTML: function() {
            ...
            !d.currTemplate[t]) {
                ...
                d.currTemplate[t] = !n || u(n)
            }
            s && s !== e.type && d.container.removeClass("mfp-" + s + "-holder");
        ...
        parseEl: function(e) {
            ...
            } : (t = n.type,
            {
                ...
                for (var i = d.types, s = 0; s < i.length; s++)
        ...
        _onFocusIn: function(e) {
            if (e.target !== d.wrap[0] && !u.contains(d.wrap[0], e.target))
                return d._setFocus(),
                !1
        },
    ...
    u.fn.magnificPopup = function(e) {
        ...
        if ("string" == typeof e)
            if ("open" === e) {
                var n, i = a ? t.data("magnificPopup") : t[0].magnificPopup, s = parseInt(arguments[1], 10) || 0;
                n = i.items ? i.items[s] : (n = t,
            ...
            getAjax: function(s) {
                ...
                var e = u.extend({
                    ...
                    error: function() {
                        ...
                        d.updateStatus("error", d.st.ajax.tError.replace("%url%", s.src))
                    }
                }, d.st.ajax.settings);
                ...
                var n = 0
                  ...
                  , s = function(e) {
                    ...
                    O = setInterval(function() {
                        0 < i.naturalWidth ? d._onImageHasSize(t) : (200 < n && clearInterval(O),
                        3 === ++n ? s(10) : 40 === n ? s(50) : 100 === n && s(500))
                    }, e)
                };
                s(1)
            },
            getImage: function(e, t) {
                var n = 0
                  , i = function() {
                    ...
                    e.hasSize = !0,
                    e.loaded = !0,
                    w("ImageLoadComplete")) : ++n < 200 ? setTimeout(i, 100) : s())
                }
                  , s = function() {
                ...
                if (r.length) {
                    ...
                    e.img = u(a).on("load.mfploader", i).on("error.mfploader", s),
                    a.src = e.src,
        ...
        proto: {
            initZoom: function() {
                ...
                if (o.enabled && d.supportsTransition) {
                    var n, i, s = o.duration, r = function(e) {
                        var t = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image")
                          ...
                          , s = "transition";
                        return i["-webkit-" + s] = i["-moz-" + s] = i["-o-" + s] = i[s] = n,
                        t.css(i),
                        t
                    }, a = function() {
            ...
            _getOffset: function(e) {
                var t, n = (t = e ? d.currItem.img : d.st.zoom.opener(d.currItem.el || d.currItem)).offset(), i = parseInt(t.css("padding-top"), 10), s = parseInt(t.css("padding-bottom"), 10);
                n.top -= u(window).scrollTop() - i;
                var o = {
                    width: t.width(),
                    height: (a ? t.innerHeight() : t[0].offsetHeight) - s - i
                };
                return void 0 === P && (P = void 0 !== document.createElement("p").style.MozTransform),
                P ? o["-moz-transform"] = o.transform = "translate(" + n.left + "px," + n.top + "px)" : (o.left = n.left,
                o.top = n.top),
                o
            }
        }
    ...
    u.magnificPopup.registerModule(N, {
        ...
        proto: {
            ...
            getIframe: function(e, t) {
                ...
                var s = {};
                return i.srcAction && (s[i.srcAction] = n),
                d._parseMarkup(t, s, e),
                d.updateStatus("ready"),
                t
            }
        }
        ...
        proto: {
            initGallery: function() {
                ...
                _("UpdateStatus" + e, function(e, t) {
                    t.text && (t.text = j(t.text, d.currItem.index, d.items.length))
                }),
                _(f + e, function(e, t, n, i) {
                    var s = d.items.length;
                    n.counter = 1 < s ? j(o.tCounter, i.index, s) : ""
                }),
        ...
        proto: {
            initRetina: function() {
                if (1 < window.devicePixelRatio) {
                    var n = d.st.retina
                      , i = n.ratio;
                    1 < (i = isNaN(i) ? i() : i) && (_("ImageHasSize." + q, function(e, t) {
                        t.img.css({
                            "max-width": t.img[0].naturalWidth / i,
                            width: "100%"
                        })
                    }),
                    _("ElementParse." + q, function(e, t) {
...
function(e) {
    ...
    var i = -1
      ...
      , u = function(e) {
        ...
        return t.each(function() {
            var e = l(this)
              ...
              , n = 0 < s.length ? s[s.length - 1] : null;
            null === n ? s.push(e) : Math.floor(Math.abs(i - t)) <= 1 ? s[s.length - 1] = n.add(e) : s.push(e),
            i = t
        }),
        s
    }
      , d = function(e) {
        ...
        return "object" == typeof e ? l.extend(t, e) : ("boolean" == typeof e ? t.byRow = e : "remove" === e && (t.remove = !0),
        t)
    }
    ...
    h._apply = function(e, t) {
        ...
        a.css("display", "block"),
        o.byRow && !o.target && (n.each(function() {
            var e = l(this)
              , t = e.css("display");
        ...
        l.each(i, function(e, t) {
            ...
            if (o.target)
                ...
                if (o.byRow && n.length <= 1)
                    return void n.css(o.property, "");
                n.each(function() {
                    var e = l(this)
                      , t = e.attr("style")
                      , n = e.css("display");
            ...
            n.each(function() {
                var e = l(this)
                  , t = 0;
                o.target && e.is(o.target) || ("border-box" !== e.css("box-sizing") && (t += c(e.css("border-top-width")) + c(e.css("border-bottom-width")),
                t += c(e.css("padding-top")) + c(e.css("padding-bottom"))),
                e.css(o.property, s - t + "px"))
            })
        }),
        a.each(function() {
            var e = l(this);
        ...
        h._maintainScroll && l(window).scrollTop(s / r * l("html").outerHeight(!0)),
        this
    }
    ,
...
function(l, n, s, a) {
    ...
    c.Workers = [{
        ...
        run: function() {
            var e, t, n, i, s = this.settings.rtl ? 1 : -1, o = 2 * this.settings.stagePadding, r = this.coordinates(this.current()) + o, a = r + this.width() * s, l = [];
            for (n = 0,
            i = this._coordinates.length; n < i; n++)
                e = this._coordinates[n - 1] || 0,
                t = Math.abs(this._coordinates[n]) + o * s,
                (this.op(e, "<=", r) && this.op(e, ">", a) || this.op(t, "<", r) && this.op(t, ">", a)) && l.push(n);
    ...
    c.prototype.onDragStart = function(e) {
        ...
        l(s).one("mousemove.owl.core touchmove.owl.core", l.proxy(function(e) {
    ...
    c.prototype.onDragEnd = function(e) {
        ...
        this.current(this.closest(n.x, 0 !== t.x ? i : this._drag.direction)),
        this.invalidate("position"),
        this.update(),
    ...
    c.prototype.normalize = function(e, t) {
        ...
        return !this.isNumeric(e) || n < 1 ? e = a : (e < 0 || n + i <= e) && (e = ((e - i / 2) % n + n) % n + i / 2),
        e
    }
    ,
    ...
    c.prototype.maximum = function(e) {
        ...
        if (s.loop)
            ...
            if (t = this._items.length)
                ...
                i = this.$element.width(); t-- && !(i < (n += this._items[t].width() + this.settings.margin)); )
                    ;
            o = t + 1
        } else
    ...
    c.prototype.to = function(e, t) {
        ...
        (i = (((e = n + s) - a) % r + r) % r + a) !== e && i - s <= l && 0 < i - s && (n = i - s,
        e = i,
    ...
    c.prototype.viewport = function() {
        var e;
        return this.options.responsiveBaseElement !== n ? e = l(this.options.responsiveBaseElement).width() : n.innerWidth ? e = n.innerWidth : s.documentElement && s.documentElement.clientWidth ? e = s.documentElement.clientWidth : console.warn("Can not detect viewport width."),
        e
    }
    ,
    ...
    c.prototype.add = function(e, t) {
        ...
        this._items.push(e),
        this._mergers.push(1 * e.find("[data-merge]").addBack("[data-merge]").attr("data-merge") || 1)) : (this._items[t].before(e),
        this._items.splice(t, 0, e),
        this._mergers.splice(t, 0, 1 * e.find("[data-merge]").addBack("[data-merge]").attr("data-merge") || 1)),
...
function(a, o, e, t) {
    ...
    n.prototype.load = function(e) {
        ...
        !n || -1 < a.inArray(t.get(0), this._loaded) || (n.each(a.proxy(function(e, t) {
            var n, i = a(t), s = 1 < o.devicePixelRatio && i.attr("data-src-retina") || i.attr("data-src") || i.attr("data-srcset");
...
function(u, e, t, n) {
    ...
    i.prototype.thumbnail = function(t, e) {
        var n, i, s = e.width && e.height ? "width:" + e.width + "px;height:" + e.height + "px;" : "", o = t.find("img"), r = "src", a = "", l = this._core.settings, c = function(e) {
        ...
        o.length)
            ...
            o.remove(),
            !1;
        "youtube" === e.type ? (i = "//img.youtube.com/vi/" + e.id + "/hqdefault.jpg",
        c(i)) : "vimeo" === e.type ? u.ajax({
            type: "GET",
    ...
    i.prototype.play = function(e) {
        var t, n = u(e.target).closest("." + this._core.settings.itemClass), i = this._videos[n.attr("data-video")], s = i.width || "100%", o = i.height || this._core.$stage.height();
        ...
        u(t).wrap('<div class="owl-video-frame" />').insertAfter(n.find(".owl-video")),
...
function(r, e, t, n) {
    ...
    i.prototype.swap = function() {
        if (1 === this.core.settings.items && r.support.animation && r.support.transition) {
            this.core.speed(0);
            var e, t = r.proxy(this.clear, this), n = this.core.$stage.children().eq(this.previous), i = this.core.$stage.children().eq(this.next), s = this.core.settings.animateIn, o = this.core.settings.animateOut;
...
function(o, e, t, n) {
    ...
    i.prototype.initialize = function() {
        ...
        for (e in this._controls.$relative = (n.navContainer ? o(n.navContainer) : o("<div>").addClass(n.navContainerClass).appendTo(this.$element)).addClass("disabled"),
        this._controls.$previous = o("<" + n.navElement + ">").addClass(n.navClass[0]).html(n.navText[0]).prependTo(this._controls.$relative).on("click", o.proxy(function(e) {
            this.prev(n.navSpeed)
        }, this)),
        this._controls.$next = o("<" + n.navElement + ">").addClass(n.navClass[1]).html(n.navText[1]).appendTo(this._controls.$relative).on("click", o.proxy(function(e) {
        ...
        this._controls.$absolute.on("click", "button", o.proxy(function(e) {
    ...
    i.prototype.destroy = function() {
        var e, t, n, i, s;
        for (e in s = this._core.settings,
        this._handlers)
    ...
    i.prototype.draw = function() {
        var e, t = this._core.settings, n = this._core.items().length <= t.items, i = this._core.relative(this._core.current()), s = t.loop || t.rewind;
        ...
        t.dotsData && 0 !== e ? this._controls.$absolute.html(this._templates.join("")) : 0 < e ? this._controls.$absolute.append(new Array(e + 1).join(this._templates[0])) : e < 0 && this._controls.$absolute.children().slice(e).remove(),
    ...
    i.prototype.getPosition = function(e) {
        ...
        return "page" == i.slideBy ? (t = o.inArray(this.current(), this._pages),
    ...
    i.prototype.to = function(e, t, n) {
        ...
        o.proxy(this._overrides.to, this._core)(this._pages[(e % i + i) % i].start, t)) : o.proxy(this._overrides.to, this._core)(e, t)
    }
    ,
        ...
        this._handlers = {
            ...
            "changed.owl.carousel": i.proxy(function(e) {
                if (e.namespace && "position" === e.property.name) {
                    ...
                    if (!t || s.location.hash.slice(1) === t)
                        return;
                    s.location.hash = t
                }
            }, this)
...
function(s, e, t, o) {
    ...
    c() && (s.support.animation = new String(d("animation")),
    s.support.animation.end = n.animation.end[s.support.animation]),
    i() && (s.support.transform = new String(d("transform")),
...
"object" == typeof navigator && function(e, t) {
    ...
    var t = function(e) {
      ...
      , h = function(e) {
        return s(e) || (l(e) || c(e) || d(e)) && !e.length || r(e) && !Object.keys(e).length
    }
      , g = {
        nullOrUndefined: s,
        object: r,
        ...
        track: function(e) {
            return n(e, TextTrack) || !s(e) && l(e.kind)
        },
        url: function(e) {
            if (n(e, window.URL))
                return !0;
    ...
    function f(t, e, n) {
        ...
        if (t && "addEventListener"in t && !g.empty(e) && g.function(n)) {
            ...
            a.forEach(function(e) {
                i && i.eventListeners && s && i.eventListeners.push({
                    element: t,
                    type: e,
                    callback: n,
                    options: l
                }),
                t[s ? "addEventListener" : "removeEventListener"](e, n, l)
            })
        }
    }
    function v(e) {
    ...
    function w(e, o) {
        ...
        Array.from(t).reverse().forEach(function(e, t) {
            var n = 0 < t ? o.cloneNode(!0) : o
              ...
              , s = e.nextSibling;
            n.appendChild(e),
            s ? i.insertBefore(n, s) : i.appendChild(n)
        })
    }
    function C(s, e) {
        g.element(s) && !g.empty(e) && Object.entries(e).filter(function(e) {
            var t = m(e, 2)[1];
            ...
            var t = m(e, 2)
              , n = t[0]
              , i = t[1];
            return s.setAttribute(n, i)
        })
    }
    function T(e, t, n) {
        var i = document.createElement(e);
        return g.object(t) && C(i, t),
        g.string(n) && (i.innerText = n),
        i
    }
    function E(e, t, n, i) {
        g.element(t) && t.appendChild(T(e, n, i))
    }
    function k(e) {
        g.nodeList(e) || g.array(e) ? Array.from(e).forEach(k) : g.element(e) && g.element(e.parentNode) && e.parentNode.removeChild(e)
    }
    function S(e) {
        if (g.element(e))
    ...
    function A(e, t) {
        return g.element(t) && g.element(t.parentNode) && g.element(e) ? (t.parentNode.replaceChild(e, t),
        e) : null
    }
    function x(e, t) {
        if (!g.string(e) || g.empty(e))
            return {};
        var r = {}
          , a = t;
        return e.split(",").forEach(function(e) {
            ...
            switch (t.charAt(0)) {
            case ".":
                g.object(a) && g.string(a.class) && (a.class += " ".concat(n)),
                r.class = n;
                break;
            case "#":
                r.id = t.replace("#", "");
    ...
    function M() {
        ...
        t && $(e, this.config.classNames.tabFocus))
    }
    var L, j, q, H = (L = document.createElement("span"),
    j = {
        WebkitTransition: "webkitTransitionEnd",
        MozTransition: "transitionend",
    ...
    var z, F = {
        ...
        check: function(e, t, n) {
            var i = F.isIPhone && n && U.playsinline
              , s = U[e] || "html5" !== t;
            return {
                api: s,
                ui: s && U.rangeInput && ("video" !== e || !F.isIPhone || i)
            }
        },
        pip: !(F.isIPhone || !g.function(T("video").webkitSetPresentationMode) && (!document.pictureInPictureEnabled || T("video").disablePictureInPicture)),
        ...
        mime: function(e) {
            ...
            if (!this.isHTML5 || t !== this.type)
                return !1;
            Object.keys(B).includes(n) && (n += '; codecs="'.concat(B[e], '"'));
            try {
        ...
        rangeInput: (z = document.createElement("input"),
        (z.type = "range") === z.type),
        ...
        getSources: function() {
            ...
            return this.isHTML5 ? Array.from(this.media.querySelectorAll("source")).filter(function(e) {
                return U.mime.call(t, e.getAttribute("type"))
            }) : []
        },
        ...
        extend: function() {
            if (this.isHTML5) {
                ...
                Object.defineProperty(a.media, "quality", {
                    get: function() {
                        var e = W.getSources.call(a).find(function(e) {
                    ...
                    set: function(t) {
                        ...
                        if (e) {
                            ...
                            ("none" !== o || r) && (a.once("loadedmetadata", function() {
                                a.currentTime = i,
                                s || a.play()
                            }),
                            a.media.load()),
        ...
        cancelRequests: function() {
            this.isHTML5 && (k(W.getSources.call(this)),
    ...
    function Q() {
        for (var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, e = arguments.length, n = new Array(1 < e ? e - 1 : 0), i = 1; i < e; i++)
            n[i - 1] = arguments[i];
        if (!n.length)
            return t;
        var s = n.shift();
        return g.object(s) ? (Object.keys(s).forEach(function(e) {
            g.object(s[e]) ? (Object.keys(t).includes(e) || Object.assign(t, o({}, e, {})),
            Q(t[e], s[e])) : Object.assign(t, o({}, e, s[e]))
        }),
        Q.apply(void 0, [t].concat(n))) : t
    }
    function Y(e) {
    ...
    var ee = {
      ...
      , te = function() {
        var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : ""
          , t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
        if (g.empty(e) || g.empty(t))
            return "";
        var s = K(t.i18n, e);
        if (g.empty(s))
            return Object.keys(ee).includes(e) ? ee[e] : "";
        var n = {
            "{seektime}": t.seekTime,
            "{title}": t.title
        };
    ...
    function ie(e) {
        var s = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "text";
        ...
        if (g.string(e)) {
            ...
            if (!n || !i()) {
                ...
                ie(e).then(function(e) {
                    g.empty(e) || (o && window.localStorage.setItem("".concat("cache", "-").concat(t), JSON.stringify({
                        content: e
                    })),
                    s(r, e))
                }).catch(function() {})
    ...
    function le() {
        ...
        var i = function(e) {
          ...
          , o = re(e)
          , r = ae(e);
        return s = t || 0 < s ? "".concat(s, ":") : "",
        "".concat(n && 0 < e ? "-" : "").concat(s).concat(i(o), ":").concat(i(r))
    }
    var ce = {
        getIconUrl: function() {
        ...
        findElements: function() {
            try {
                ...
                g.element(this.elements.progress) && (this.elements.display.seekTooltip = this.elements.progress.querySelector(".".concat(this.config.classNames.tooltip))),
                !0
            } catch (e) {
        ...
        createButton: function(e, t) {
            ...
            Object.keys(n).includes("class") ? n.class.includes(this.config.classNames.control) || (n.class += " ".concat(this.config.classNames.control)) : n.class = this.config.classNames.control,
            e) {
            case "play":
                s.toggle = !0,
                s.label = "play",
            ...
            case "play-large":
                ...
                break;
            default:
                g.empty(s.label) && (s.label = i),
                g.empty(s.icon) && (s.icon = e)
            }
            var o = T(s.element);
            return s.toggle ? (o.appendChild(ce.createIcon.call(this, s.iconPressed, {
                class: "icon--pressed"
            })),
            o.appendChild(ce.createIcon.call(this, s.icon, {
                class: "icon--not-pressed"
            })),
            o.appendChild(ce.createLabel.call(this, s.labelPressed, {
                class: "label--pressed"
            })),
            o.appendChild(ce.createLabel.call(this, s.label, {
                class: "label--not-pressed"
            }))) : (o.appendChild(ce.createIcon.call(this, s.icon)),
            o.appendChild(ce.createLabel.call(this, s.label))),
            Q(n, x(this.config.selectors.buttons[i], n)),
            C(o, n),
            "play" === i ? (g.array(this.elements.buttons[i]) || (this.elements.buttons[i] = []),
            this.elements.buttons[i].push(o)) : this.elements.buttons[i] = o,
            o
        },
        createRange: function(e, t) {
            var n = T("input", Q(x(this.config.selectors.inputs[e]), {
                type: "range",
                min: 0,
                max: 100,
                step: .01,
            ...
            ce.updateRangeFill.call(this, n),
            n
        },
        createProgress: function(e, t) {
            var n = T("progress", Q(x(this.config.selectors.display[e]), {
                min: 0,
                max: 100,
                value: 0,
                role: "presentation",
            ...
            if ("volume" !== e) {
                n.appendChild(T("span", null, "0"));
                var i = {
                    played: "played",
                    buffer: "buffered"
                }[e]
                  , s = i ? te(i, this.config) : "";
                n.innerText = "% ".concat(s.toLowerCase())
            }
        ...
        bindMenuItemShortcuts: function(i, s) {
            var o = this;
            v(i, "keydown keyup", function(e) {
                if ([32, 38, 39, 40].includes(e.which) && (e.preventDefault(),
                e.stopPropagation(),
                "keydown" !== e.type)) {
                    var t, n = O(i, '[role="menuitemradio"]');
                    if (!n && [32, 39].includes(e.which))
                        ce.showMenuPanel.call(o, s, !0);
                    else
                        32 !== e.which && (40 === e.which || n && 39 === e.which ? (t = i.nextElementSibling,
                        g.element(t) || (t = i.parentNode.firstElementChild)) : (t = i.previousElementSibling,
                        g.element(t) || (t = i.parentNode.lastElementChild)),
                        M.call(o, t, !0))
                }
            }, !1),
            v(i, "keyup", function(e) {
                13 === e.which && ce.focusFirstMenuItem.call(o, null, !0)
            })
        },
        createMenuItem: function(e) {
            var t = this
              ...
              , l = e.checked
              , c = void 0 !== l && l
              , u = x(this.config.selectors.inputs[s])
              , d = T("button", Q(u, {
                type: "button",
                role: "menuitemradio",
            ...
            this.listeners.bind(d, "click keyup", function(e) {
                if (!g.keyboardEvent(e) || 32 === e.which) {
                    ...
                    ce.showMenuPanel.call(t, "home", g.keyboardEvent(e))
                }
            }, s, !1),
            ce.bindMenuItemShortcuts.call(this, d, s),
            i.appendChild(d)
        },
        formatTime: function() {
            var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0
              , t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
            return g.number(e) ? le(e, 0 < oe(this.duration), t) : e
        },
        updateTimeDisplay: function() {
            var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null
              , t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0
              , n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2];
            g.element(e) && g.number(t) && (e.innerText = ce.formatTime(t, n))
        },
        updateVolume: function() {
            this.supported.ui && (g.element(this.elements.inputs.volume) && ce.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
            g.element(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
        },
        setRange: function(e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0;
            g.element(e) && (e.value = t,
            ce.updateRangeFill.call(this, e))
        },
            ...
            if (this.supported.ui && g.event(e)) {
                ...
                if (e)
                    ...
                    case "seeked":
                        t = this.currentTime,
                        n = this.duration,
                        i = 0 === t || 0 === n || Number.isNaN(t) || Number.isNaN(n) ? 0 : (t / n * 100).toFixed(2),
                        "timeupdate" === e.type && ce.setRange.call(this, this.elements.inputs.seek, i);
                        break;
                    case "playing":
                    case "progress":
                        !function(e, t) {
                            var n = g.number(t) ? t : 0
                              , i = g.element(e) ? e : o.elements.display.buffer;
                            if (g.element(i)) {
                                i.value = n;
                                var s = i.getElementsByTagName("span")[0];
                                g.element(s) && (s.childNodes[0].nodeValue = n)
                            }
        ...
        updateRangeFill: function(e) {
            ...
            if (g.element(t) && "range" === t.getAttribute("type")) {
                if (O(t, this.config.selectors.inputs.seek)) {
                    t.setAttribute("aria-valuenow", this.currentTime);
                    var n = ce.formatTime(this.currentTime)
                      , i = ce.formatTime(this.duration)
                      , s = te("seekLabel", this.config);
                    t.setAttribute("aria-valuetext", s.replace("{currentTime}", n).replace("{duration}", i))
                } else if (O(t, this.config.selectors.inputs.volume)) {
                    var o = 100 * t.value;
        ...
        updateSeekTooltip: function(e) {
            ...
            if (this.config.tooltips.seek && g.element(this.elements.inputs.seek) && g.element(this.elements.display.seekTooltip) && 0 !== this.duration) {
                var n = 0
                  ...
                  , o = function(e) {
                    $(t.elements.display.seekTooltip, s, e)
                };
                if (this.touch)
                    o(!1);
                else {
                    if (g.event(e))
                        ...
                        if (!D(this.elements.display.seekTooltip, s))
                            return;
                        n = parseFloat(this.elements.display.seekTooltip.style.left, 10)
                    }
                    n < 0 ? n = 0 : 100 < n && (n = 100),
                    ce.updateTimeDisplay.call(this, this.elements.display.seekTooltip, this.duration / 100 * n),
                    this.elements.display.seekTooltip.style.left = "".concat(n, "%"),
                    g.event(e) && ["mouseenter", "mouseleave"].includes(e.type) && o("mouseenter" === e.type)
                }
            }
        },
        timeUpdate: function(e) {
            var t = !g.element(this.elements.display.duration) && this.config.invertTime;
            ce.updateTimeDisplay.call(this, this.elements.display.currentTime, t ? this.duration - this.currentTime : this.currentTime, t),
            e && "timeupdate" === e.type && this.media.seeking || ce.updateProgress.call(this, e)
        },
        durationUpdate: function() {
            if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
                if (this.duration >= Math.pow(2, 32))
                    return I(this.elements.display.currentTime, !0),
                ...
                !e && this.config.displayDuration && this.paused && ce.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
                e && ce.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
        ...
        updateSetting: function(e, t, n) {
            ...
            if ("captions" === e)
                ...
                if (s = g.empty(n) ? this[e] : n,
                g.empty(s) && (s = this.config[e].default),
                !g.empty(this.options[e]) && !this.options[e].includes(s))
            ...
            if (g.element(o) || (o = i && i.querySelector('[role="menu"]')),
            g.element(o)) {
                this.elements.settings.buttons[e].querySelector(".".concat(this.config.classNames.menu.value)).innerHTML = ce.getLabel.call(this, e, s);
                var r = o && o.querySelector('[value="'.concat(s, '"]'));
                g.element(r) && (r.checked = !0)
            }
        },
        ...
        setQualityMenu: function(e) {
            ...
            if (g.element(this.elements.settings.panels.quality)) {
                ...
                g.array(e) && (this.options.quality = V(e).filter(function(e) {
                    return i.config.quality.options.includes(e)
                }));
                var t = !g.empty(this.options.quality) && 1 < this.options.quality.length;
                if (ce.toggleMenuButton.call(this, s, t),
                S(o),
                ...
                t) {
                    this.options.quality.sort(function(e, t) {
                        ...
                        var t, n;
                        ce.createMenuItem.call(i, {
                            value: e,
                            list: o,
                            type: s,
                            title: ce.getLabel.call(i, "quality", e),
                            badge: (t = e,
                            n = te("qualityBadge.".concat(t), i.config),
                            n.length ? ce.createBadge.call(i, n) : null)
                        })
                    }),
                    ce.updateSetting.call(this, s, o)
                }
            }
        },
        setCaptionsMenu: function() {
            ...
            if (g.element(this.elements.settings.panels.captions)) {
                var e = "captions"
                  ...
                  , t = he.getTracks.call(this)
                  , s = Boolean(t.length);
                if (ce.toggleMenuButton.call(this, e, s),
                S(i),
                ce.checkMenu.call(this),
                s) {
                    var o = t.map(function(e, t) {
                        return {
                            ...
                            title: he.getLabel.call(n, e),
                            badge: e.language && ce.createBadge.call(n, e.language.toUpperCase()),
                            list: i,
                            type: "language"
                        }
                    });
                    ...
                    o.forEach(ce.createMenuItem.bind(this)),
                    ce.updateSetting.call(this, e, i)
                }
            }
        },
        setSpeedMenu: function(e) {
            ...
            if (g.element(this.elements.settings.panels.speed)) {
                ...
                g.array(e) ? this.options.speed = e : (this.isHTML5 || this.isVimeo) && (this.options.speed = [.5, .75, 1, 1.25, 1.5, 1.75, 2]),
                this.options.speed = this.options.speed.filter(function(e) {
                    return t.config.speed.options.includes(e)
                });
                var s = !g.empty(this.options.speed) && 1 < this.options.speed.length;
                ce.toggleMenuButton.call(this, n, s),
                S(i),
                ce.checkMenu.call(this),
                s && (this.options.speed.forEach(function(e) {
                ...
                ce.updateSetting.call(this, n, i))
            }
        },
        checkMenu: function() {
        ...
        toggleMenu: function(e) {
            ...
            if (g.element(t) && g.element(n)) {
                ...
                if (g.boolean(e))
                    s = e;
                else if (g.keyboardEvent(e) && 27 === e.which)
                    s = !1;
                else if (g.event(e)) {
                ...
                I(t, !s),
                $(this.elements.container, this.config.classNames.menu.open, s),
                s && g.keyboardEvent(e) ? ce.focusFirstMenuItem.call(this, null, !0) : s || i || M.call(this, n, g.keyboardEvent(e))
            }
        },
        ...
        showMenuPanel: function() {
            ...
            if (g.element(i)) {
                var s = i.parentNode
                  , o = Array.from(s.children).find(function(e) {
                    return !e.hidden
                });
                if (U.transitions && !U.reducedMotion) {
                    s.style.width = "".concat(o.scrollWidth, "px"),
                    s.style.height = "".concat(o.scrollHeight, "px");
                    var r = ce.getMenuSize.call(this, i);
                    v.call(this, s, H, function e(t) {
                ...
                I(o, !0),
                I(i, !1),
                ce.focusFirstMenuItem.call(this, i, t)
            }
        },
        ...
        create: function(r) {
            var a = this
              , e = T("div", x(this.config.selectors.controls.wrapper));
            if (this.config.controls.includes("restart") && e.appendChild(ce.createButton.call(this, "restart")),
            this.config.controls.includes("rewind") && e.appendChild(ce.createButton.call(this, "rewind")),
            this.config.controls.includes("play") && e.appendChild(ce.createButton.call(this, "play")),
            this.config.controls.includes("fast-forward") && e.appendChild(ce.createButton.call(this, "fast-forward")),
            this.config.controls.includes("progress")) {
                var t = T("div", x(this.config.selectors.progress));
                if (t.appendChild(ce.createRange.call(this, "seek", {
                    id: "plyr-seek-".concat(r.id)
                })),
                t.appendChild(ce.createProgress.call(this, "buffer")),
                this.config.tooltips.seek) {
                    var n = T("span", {
                        class: this.config.classNames.tooltip
                    }, "00:00");
                    t.appendChild(n),
                    this.elements.display.seekTooltip = n
                }
                this.elements.progress = t,
                e.appendChild(this.elements.progress)
            }
            if (this.config.controls.includes("current-time") && e.appendChild(ce.createTime.call(this, "currentTime")),
            this.config.controls.includes("duration") && e.appendChild(ce.createTime.call(this, "duration")),
            this.config.controls.includes("mute") || this.config.controls.includes("volume")) {
                var i = T("div", {
                    class: "plyr__volume"
                });
                if (this.config.controls.includes("mute") && i.appendChild(ce.createButton.call(this, "mute")),
                this.config.controls.includes("volume")) {
                    ...
                    i.appendChild(ce.createRange.call(this, "volume", Q(s, {
            ...
            if (this.config.controls.includes("captions") && e.appendChild(ce.createButton.call(this, "captions")),
            this.config.controls.includes("settings") && !g.empty(this.config.settings)) {
                var o = T("div", {
                    class: "plyr__menu",
                    hidden: ""
                });
                o.appendChild(ce.createButton.call(this, "settings", {
                    "aria-haspopup": !0,
                ...
                this.config.settings.forEach(function(e) {
                    var t = T("button", Q(x(a.config.selectors.buttons.settings), {
                        type: "button",
                    ...
                    ce.bindMenuItemShortcuts.call(a, t, e),
                    v(t, "click", function() {
                        ce.showMenuPanel.call(a, e, !1)
                    });
                    var n = T("span", null, te(e, a.config))
                      , i = T("span", {
                    ...
                    }, te("menuBack", a.config))),
                    v(s, "keydown", function(e) {
                        37 === e.which && (e.preventDefault(),
                        e.stopPropagation(),
                        ce.showMenuPanel.call(a, "home", !0))
                    }, !1),
                    v(o, "click", function() {
                        ce.showMenuPanel.call(a, "home", !1)
                    }),
                    s.appendChild(o),
                    s.appendChild(T("div", {
                        role: "menu"
                    ...
                    c.appendChild(s),
                    a.elements.settings.buttons[e] = t,
                    a.elements.settings.panels[e] = s
                }),
                l.appendChild(c),
                o.appendChild(l),
                e.appendChild(o),
                this.elements.settings.popup = l,
                this.elements.settings.menu = o
            }
            if (this.config.controls.includes("pip") && U.pip && e.appendChild(ce.createButton.call(this, "pip")),
            this.config.controls.includes("airplay") && U.airplay && e.appendChild(ce.createButton.call(this, "airplay")),
            this.config.controls.includes("download")) {
                ...
                !g.url(p) && this.isEmbed && Q(h, {
                    icon: "logo-".concat(this.provider),
                    label: this.provider
                }),
                e.appendChild(ce.createButton.call(this, "download", h))
            }
            return this.config.controls.includes("fullscreen") && e.appendChild(ce.createButton.call(this, "fullscreen")),
            this.config.controls.includes("play-large") && this.elements.container.appendChild(ce.createButton.call(this, "play-large")),
            this.elements.controls = e,
            this.isHTML5 && ce.setQualityMenu.call(this, W.getQualityOptions.call(this)),
        ...
        inject: function() {
            ...
            if (this.config.loadSprite) {
                var e = ce.getIconUrl.call(this);
                e.cors && se(e.url, "sprite-plyr")
            }
            ...
            var n = {
              ...
              , s = !0;
            g.function(this.config.controls) && (this.config.controls = this.config.controls.call(this.props)),
            this.config.controls || (this.config.controls = []),
            g.element(this.config.controls) || g.string(this.config.controls) ? t = this.config.controls : (t = ce.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
            ...
            if (s && (g.string(this.config.controls) ? t = r(t) : g.element(t) && (t.innerHTML = r(t.innerHTML))),
            g.string(this.config.selectors.controls.container) && (o = document.querySelector(this.config.selectors.controls.container)),
            g.element(o) || (o = this.elements.container),
            o[g.element(t) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", t),
            g.element(this.elements.controls) || ce.findElements.call(this),
            ...
            if (window.navigator.userAgent.includes("Edge") && R(o),
            this.config.tooltips.controls) {
                ...
                Array.from(h).forEach(function(e) {
                    $(e, i.config.classNames.hidden, !1),
                    $(e, i.config.classNames.tooltip, !0)
                })
            }
        }
    };
    ...
    var he = {
        setup: function() {
            if (this.supported.ui)
                if (!this.isVideo || this.isYouTube || this.isHTML5 && !U.textTracks)
                    g.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && ce.setCaptionsMenu.call(this);
                else {
                    var e, t;
                    if (g.element(this.elements.captions) || (this.elements.captions = T("div", x(this.config.selectors.captions)),
                    e = this.elements.captions,
                    t = this.elements.wrapper,
                    g.element(e) && g.element(t) && t.parentNode.insertBefore(e, t.nextSibling)),
                    F.isIE && window.URL) {
                        var n = this.media.querySelectorAll("track");
                        Array.from(n).forEach(function(t) {
                            var e = t.getAttribute("src")
                              , n = ue(e);
                            null !== n && n.hostname !== window.location.href.hostname && ["http:", "https:"].includes(n.protocol) && ie(e, "blob").then(function(e) {
                    ...
                    var i = V((navigator.languages || [navigator.language || navigator.userLanguage || "en"]).map(function(e) {
                        return e.split("-")[0]
                    }))
                    ...
                    if (g.boolean(o) || (o = this.config.captions.active),
                    ...
                    this.isHTML5) {
                        ...
                        v.call(this, this.media.textTracks, r, he.update.bind(this))
                    }
        ...
        update: function() {
            ...
            this.isHTML5 && this.isVideo && e.filter(function(e) {
                ...
                e.mode = "hidden",
                v.call(t, e, "cuechange", function() {
                    return he.updateCues.call(t)
                })
            }),
            (a && this.language !== s || !e.includes(r)) && (he.setLanguage.call(this, s),
            he.toggle.call(this, i && a)),
            $(this.elements.container, this.config.classNames.captions.enabled, !g.empty(e)),
            (this.config.controls || []).includes("settings") && this.config.settings.includes("captions") && ce.setCaptionsMenu.call(this)
        },
        toggle: function(e) {
            var t = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1];
            if (this.supported.ui) {
                ...
                if (s !== n) {
                    ...
                    !this.language && s && !t) {
                        var o = he.getTracks.call(this)
                          , r = he.findTrack.call(this, [this.captions.language].concat(a(this.captions.languages)), !0);
                    ...
                    $(this.elements.container, i, s),
                    this.captions.toggled = s,
                    ce.updateSetting.call(this, "captions"),
                    b.call(this, this.media, s ? "captionsenabled" : "captionsdisabled")
                }
            }
        },
        set: function(e) {
                ...
                if (g.number(e))
                    if (e in n) {
                        if (this.captions.currentTrack !== e) {
                            var i = n[this.captions.currentTrack = e]
                              , s = (i || {}).language;
        ...
        setLanguage: function(e) {
            ...
            if (g.string(e)) {
                ...
                var i = he.getTracks.call(this)
                  , s = he.findTrack.call(this, [n]);
                he.set.call(this, i.indexOf(s), t)
            } else
        ...
        findTrack: function(e) {
            var n, t = this, i = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], s = he.getTracks.call(this), o = function(e) {
        ...
        getLabel: function(e) {
            var t = e;
            return !g.track(t) && U.textTracks && this.captions.toggled && (t = he.getCurrentTrack.call(this)),
            g.track(t) ? g.empty(t.label) ? g.empty(t.language) ? te("enabled", this.config) : e.language.toUpperCase() : t.label : te("disabled", this.config)
        },
                ...
                if (g.element(this.elements.captions))
                    if (g.nullOrUndefined(e) || Array.isArray(e)) {
                        ...
                        if (i !== this.elements.captions.innerHTML) {
                            ...
                            var s = T("span", x(this.config.selectors.caption));
                            s.innerHTML = i,
    ...
    function Ce() {
        ...
        $(this.target, this.player.config.classNames.fullscreen.fallback, t),
        F.isIos) {
            var n = document.head.querySelector('meta[name="viewport"]')
              , i = "viewport-fit=cover";
            n || (n = document.createElement("meta")).setAttribute("name", "viewport");
            var s = g.string(n.content) && n.content.includes(i);
            t ? (this.cleanupViewport = !s,
            s || (n.content += ",".concat(i))) : this.cleanupViewport && (n.content = n.content.split(",").filter(function(e) {
                return e.trim() !== i
            }).join(",")),
            setTimeout(function() {
                return R(e.target)
    ...
    var Te = function() {
        function n(e) {
            ...
            v.call(this.player, document, "ms" === this.prefix ? "MSFullscreenChange" : "".concat(this.prefix, "fullscreenchange"), function() {
                we.call(t)
            }),
        ...
        return e(n, [{
            key: "update",
            value: function() {
                this.enabled ? this.player.debug.log("".concat(n.native ? "Native" : "Fallback", " fullscreen enabled")) : this.player.debug.log("Fullscreen not supported and fallback disabled"),
                $(this.player.elements.container, this.player.config.classNames.fullscreen.enabled, this.enabled)
            }
        }, {
            key: "enter",
            value: function() {
                this.enabled && (F.isIos && this.player.config.fullscreen.iosNative ? this.target.webkitEnterFullscreen() : n.native ? this.prefix ? g.empty(this.prefix) || this.target["".concat(this.prefix, "Request").concat(this.property)]() : this.target.requestFullscreen() : Ce.call(this, !0))
            }
        }, {
            key: "exit",
            value: function() {
            ...
            get: function() {
                ...
                return ["webkit", "moz", "ms"].some(function(e) {
                    return !(!g.function(document["".concat(e, "ExitFullscreen")]) && !g.function(document["".concat(e, "CancelFullScreen")])) && (t = e,
                    !0)
                }),
                t
            }
    ...
    var ke = {
        addStyleHook: function() {
            $(this.elements.container, this.config.selectors.container.replace(".", ""), !0),
            $(this.elements.container, this.config.classNames.uiSupported, this.supported.ui)
        },
        ...
        build: function() {
            ...
            !this.supported.ui)
                ...
                void ke.toggleNativeControls.call(this, !0);
            g.element(this.elements.controls) || (ce.inject.call(this),
            this.listeners.controls()),
            ke.toggleNativeControls.call(this),
            ...
            ke.checkPlaying.call(this),
            $(this.elements.container, this.config.classNames.pip.supported, U.pip && this.isHTML5 && this.isVideo),
            $(this.elements.container, this.config.classNames.airplay.supported, U.airplay && this.isHTML5),
            $(this.elements.container, this.config.classNames.isIos, F.isIos),
            $(this.elements.container, this.config.classNames.isTouch, this.touch),
            this.ready = !0,
            setTimeout(function() {
                b.call(e, e.media, "ready")
            }, 0),
            ke.setTitle.call(this),
            this.poster && ke.setPoster.call(this, this.poster, !1).catch(function() {}),
            this.config.duration && ce.durationUpdate.call(this)
        },
        setTitle: function() {
            var t = te("play", this.config);
            if (g.string(this.config.title) && !g.empty(this.config.title) && (t += ", ".concat(this.config.title)),
        ...
        togglePoster: function(e) {
            $(this.elements.container, this.config.classNames.posterEnabled, e)
        },
        setPoster: function(t) {
            ...
            function() {
                ...
                return new Promise(function(e) {
                    return t.ready ? setTimeout(e, 0) : v.call(t, t.elements.container, "ready", e)
                }
                ).then(function() {})
            }
            .call(this).then(function() {
                ...
                throw t === n.poster && ke.togglePoster.call(n, !1),
                e
            }).then(function() {
                if (t !== n.poster)
                ...
                ke.togglePoster.call(n, !0),
                t
            })) : Promise.reject(new Error("Poster already set"))
        },
        checkPlaying: function(e) {
            var t = this;
            $(this.elements.container, this.config.classNames.playing, this.playing),
            $(this.elements.container, this.config.classNames.paused, this.paused),
            $(this.elements.container, this.config.classNames.stopped, this.stopped),
            Array.from(this.elements.buttons.play || []).forEach(function(e) {
                e.pressed = t.playing
            }),
            g.event(e) && "timeupdate" === e.type || ke.toggleControls.call(this)
        },
        checkLoading: function(e) {
            ...
            this.timers.loading = setTimeout(function() {
                $(t.elements.container, t.config.classNames.loading, t.loading),
                ke.toggleControls.call(t)
            }, this.loading ? 250 : 0)
        },
        ...
        return e(t, [{
                ...
                if (!(e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) && g.number(i)) {
                    if (s) {
                        ...
                        if (g.element(r)) {
                            ...
                            if (r !== n.inputs.seek && O(r, a))
                                return;
                            if (32 === e.which && O(r, 'button, [role^="menuitem"]'))
                                return
                        }
                        ...
                        !t.fullscreen.enabled && t.fullscreen.active && 27 === i && t.fullscreen.toggle(),
                        this.lastKey = i
                    } else
                        this.lastKey = null
                }
            ...
            value: function() {
                var e = this.player
                  , t = e.elements;
                e.touch = !0,
                $(t.container, e.config.classNames.isTouch, !0)
            }
        }, {
            key: "setTabFocus",
            value: function(e) {
                ...
                "keydown" !== e.type || 9 === e.which) {
                    ...
                    var i, s = e.timeStamp - this.lastKeyDown <= 20;
                    if ("focus" !== e.type || s)
                        i = t.config.classNames.tabFocus,
                        $(P.call(t, ".".concat(i)), i, !1),
                        this.focusTimer = setTimeout(function() {
                            var e = document.activeElement;
                            n.container.contains(e) && $(document.activeElement, t.config.classNames.tabFocus, !0)
                        }, 10)
                }
            }
        }, {
            ...
            value: function() {
                var e = !(0 < arguments.length && void 0 !== arguments[0]) || arguments[0]
                  , t = this.player;
                t.config.keyboard.global && f.call(t, window, "keydown keyup", this.handleKey, e, !1),
                f.call(t, document.body, "click", this.toggleMenu, e),
                _.call(t, document.body, "touchstart", this.firstTouch),
                f.call(t, document.body, "keydown focus blur", this.setTabFocus, e, !1, !0)
            }
        }, {
            key: "container",
            value: function() {
                var i = this.player
                  , s = i.elements;
                !i.config.keyboard.global && i.config.keyboard.focused && v.call(i, s.container, "keydown keyup", this.handleKey, !1),
                v.call(i, s.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", function(e) {
                    var t = s.controls;
                    t && "enterfullscreen" === e.type && (t.pressed = !1,
                    t.hover = !1);
                    var n = 0;
                    ["touchstart", "touchmove", "mousemove"].includes(e.type) && (ke.toggleControls.call(i, !0),
                    n = i.touch ? 3e3 : 2e3),
                    clearTimeout(i.timers.controls),
                    i.timers.controls = setTimeout(function() {
                        return ke.toggleControls.call(i, !1)
                    }, n)
                })
            }
        }, {
            ...
            value: function() {
                var i = this.player
                  , s = i.elements;
                if (v.call(i, i.media, "timeupdate seeking seeked", function(e) {
                    return ce.timeUpdate.call(i, e)
                }),
                v.call(i, i.media, "durationchange loadeddata loadedmetadata", function(e) {
                    return ce.durationUpdate.call(i, e)
                }),
                v.call(i, i.media, "canplay loadeddata", function() {
                    I(s.volume, !i.hasAudio),
                    I(s.buttons.mute, !i.hasAudio)
                }),
                v.call(i, i.media, "ended", function() {
                    i.isHTML5 && i.isVideo && i.config.resetOnEnd && i.restart()
                }),
                v.call(i, i.media, "progress playing seeking seeked", function(e) {
                    return ce.updateProgress.call(i, e)
                }),
                v.call(i, i.media, "volumechange", function(e) {
                    return ce.updateVolume.call(i, e)
                }),
                v.call(i, i.media, "playing play pause ended emptied timeupdate", function(e) {
                    return ke.checkPlaying.call(i, e)
                }),
                v.call(i, i.media, "waiting canplay seeked playing", function(e) {
                    return ke.checkLoading.call(i, e)
                }),
                v.call(i, i.media, "playing", function() {
                ...
                i.supported.ui && i.config.clickToPlay && !i.isAudio) {
                    var t = N.call(i, ".".concat(i.config.classNames.video));
                    if (!g.element(t))
                        return;
                    v.call(i, s.container, "click", function(e) {
                        ([s.container, t].includes(e.target) || t.contains(e.target)) && (i.touch && i.config.hideControls || (i.ended ? (i.restart(),
                        i.play()) : i.togglePlay()))
                    })
                }
                i.supported.ui && i.config.disableContextMenu && v.call(i, s.wrapper, "contextmenu", function(e) {
                    e.preventDefault()
                }, !1),
                v.call(i, i.media, "volumechange", function() {
                    i.storage.set({
                        volume: i.volume,
                        muted: i.muted
                    })
                }),
                v.call(i, i.media, "ratechange", function() {
                    ce.updateSetting.call(i, "speed"),
                    i.storage.set({
                        speed: i.speed
                    })
                }),
                v.call(i, i.media, "qualitychange", function(e) {
                    ce.updateSetting.call(i, "quality", null, e.detail.quality)
                }),
                v.call(i, i.media, "ready qualitychange", function() {
                    ce.setDownloadLink.call(i)
                });
                var e = i.config.events.concat(["keyup", "keydown"]).join(" ");
                v.call(i, i.media, e, function(e) {
                    var t = e.detail
                      , n = void 0 === t ? {} : t;
                    "error" === e.type && (n = i.media.error),
                    b.call(i, s.container, e.type, !0, n)
                })
            }
        }, {
            key: "proxy",
            value: function(e, t, n) {
                var i = this.player
                  , s = i.config.listeners[n]
                  , o = !0;
                g.function(s) && (o = s.call(i, e)),
                o && g.function(t) && t.call(i, e)
            }
        }, {
            key: "bind",
            value: function(e, t, n, i) {
                var s = this
                  ...
                  , l = g.function(a);
                v.call(r, e, t, function(e) {
                    return s.proxy(e, n, i)
                }, o && !l)
            }
        }, {
            key: "controls",
            value: function() {
                ...
                if (i.buttons.play && Array.from(i.buttons.play).forEach(function(e) {
                    s.bind(e, "click", a.togglePlay, "play")
                }),
                this.bind(i.buttons.restart, "click", a.restart, "restart"),
                this.bind(i.buttons.rewind, "click", a.rewind, "rewind"),
                this.bind(i.buttons.fastForward, "click", a.forward, "fastForward"),
                ...
                this.bind(i.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", function(e) {
                    ...
                    if (!g.keyboardEvent(e) || 39 === n || 37 === n) {
                        ...
                        var s = t.hasAttribute(i)
                          , o = ["mouseup", "touchend", "keyup"].includes(e.type);
                        s && o ? (t.removeAttribute(i),
                        a.play()) : !o && a.playing && (t.setAttribute(i, ""),
                        a.pause())
                    }
                }),
                F.isIos) {
                    var e = P.call(a, 'input[type="range"]');
                ...
                this.bind(i.inputs.seek, t, function(e) {
                    ...
                    a.currentTime = n / t.max * a.duration
                }, "seek"),
                this.bind(i.progress, "mouseenter mouseleave mousemove", function(e) {
                    return ce.updateSeekTooltip.call(a, e)
                }),
                F.isWebkit && Array.from(P.call(a, 'input[type="range"]')).forEach(function(e) {
                    s.bind(e, "input", function(e) {
                        return ce.updateRangeFill.call(a, e.target)
                    })
                }),
                a.config.toggleInvert && !g.element(i.display.duration) && this.bind(i.display.currentTime, "click", function() {
                    0 !== a.currentTime && (a.config.invertTime = !a.config.invertTime,
                    ce.timeUpdate.call(a))
                }),
                ...
                this.bind(i.controls, "focusin", function() {
                    var e = a.config
                      , t = a.elements
                      , n = a.timers;
                    $(t.controls, e.classNames.noTransition, !0),
                    ke.toggleControls.call(a, !0),
                    setTimeout(function() {
                        $(t.controls, e.classNames.noTransition, !1)
                    }, 0);
                    var i = s.touch ? 3e3 : 4e3;
                    clearTimeout(n.controls),
                    n.controls = setTimeout(function() {
                        return ke.toggleControls.call(a, !1)
                    }, i)
                }),
                this.bind(i.inputs.volume, "wheel", function(e) {
                    ...
                    a.increaseVolume(o / 50);
                    var r = a.media.volume;
                    (1 === o && r < 1 || -1 === o && 0 < r) && e.preventDefault()
                }, "volume", !1)
            }
        }]),
        t
    ...
    var Ae, xe = (function(e, t) {
        e.exports = function() {
            ...
            function h(n, i, s, o) {
                var r, a, e = document, t = s.async, l = (s.numRetries || 0) + 1, c = s.before || d, u = n.replace(/^(css|img)!/, "");
                o = o || 0,
                /(^css!|\.css$)/.test(n) ? (r = !0,
                (a = e.createElement("link")).rel = "stylesheet",
                a.href = u) : /(^img!|\.(png|gif|jpg|svg)$)/.test(n) ? (a = e.createElement("img")).src = u : ((a = e.createElement("script")).src = n,
                a.async = void 0 === t || t),
            ...
            function n(e, t, n) {
                ...
                !function(e, i, t) {
                    var n, s, o = (e = e.push ? e : [e]).length, r = o, a = [];
            ...
            return n.ready = function(e, t) {
                return function(e, n) {
                    e = e.push ? e : [e];
                    var t, i, s, o = [], r = e.length, a = r;
                    for (t = function(e, t) {
                        t.length && o.push(e),
                        --a || n(o)
                    }
    ...
    var De = {
        setup: function() {
            var t = this;
            $(this.elements.wrapper, this.config.classNames.embed, !0),
            De.setAspectRatio.call(this),
            g.object(window.Vimeo) ? De.ready.call(this) : Ie(this.config.urls.vimeo.sdk).then(function() {
                De.ready.call(t)
            }).catch(function(e) {
        ...
        ready: function() {
            var s = this
              ...
              , t = r.media.getAttribute("src");
            g.empty(t) && (t = r.media.getAttribute(r.config.attributes.embed.id));
            var n, i = (n = t,
            g.empty(n) ? null : g.number(Number(n)) ? n : n.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : n), o = T("iframe"), a = Y(r.config.urls.vimeo.iframe, i, e);
            ...
            l.appendChild(o),
            r.media = A(l, r.media),
            ie(Y(r.config.urls.vimeo.api, i), "json").then(function(e) {
                if (!g.empty(e)) {
                    var t = new URL(e[0].thumbnail_large);
                    t.pathname = "".concat(t.pathname.split("_")[0], ".jpg"),
                    ke.setPoster.call(r, t.href).catch(function() {})
                }
            }),
            r.embed = new window.Vimeo.Player(o,{
            ...
            Object.defineProperty(r.media, "currentTime", {
                ...
                set: function(e) {
                    ...
                    n.seeking = !0,
                    b.call(r, n, "seeking"),
                    Promise.resolve(o && t.setVolume(0)).then(function() {
                        return t.setCurrentTime(e)
                    }).then(function() {
                        return o && t.pause()
                    }).then(function() {
                        return o && t.setVolume(s)
                    }).catch(function() {})
                }
            });
            var u = r.config.speed.selected;
            Object.defineProperty(r.media, "playbackRate", {
                get: function() {
                    return u
                },
                set: function(e) {
                    r.embed.setPlaybackRate(e).then(function() {
                        u = e,
                        b.call(r, r.media, "ratechange")
                    }).catch(function(e) {
                        "Error" === e.name && ce.setSpeedMenu.call(r, [])
                    })
                }
            });
            var d = r.config.volume;
            Object.defineProperty(r.media, "volume", {
                get: function() {
                    return d
                },
                set: function(e) {
                    r.embed.setVolume(e).then(function() {
                        d = e,
                        b.call(r, r.media, "volumechange")
                    })
                }
            });
            var h = r.config.muted;
            Object.defineProperty(r.media, "muted", {
                ...
                set: function(e) {
                    var t = !!g.boolean(e) && e;
                    r.embed.setVolume(t ? 0 : r.config.volume).then(function() {
                        h = t,
                        b.call(r, r.media, "volumechange")
                    })
                }
            });
            var p, f = r.config.loop;
            Object.defineProperty(r.media, "loop", {
                get: function() {
                    return f
                },
                set: function(e) {
                    var t = g.boolean(e) ? e : r.config.loop.active;
                    r.embed.setLoop(t).then(function() {
                        f = t
                    })
                }
            }),
            r.embed.getVideoUrl().then(function(e) {
                p = e,
                ce.setDownloadLink.call(r)
            }).catch(function(e) {
                s.debug.warn(e)
            }),
            ...
            Promise.all([r.embed.getVideoWidth(), r.embed.getVideoHeight()]).then(function(e) {
                var t, n, i;
                De.ratio = (t = e[0],
                n = e[1],
                i = function e(t, n) {
                ...
                "".concat(t / i, ":").concat(n / i)),
                De.setAspectRatio.call(s, De.ratio)
            }),
            r.embed.setAutopause(r.config.autopause).then(function(e) {
                r.config.autopause = e
            }),
            r.embed.getVideoTitle().then(function(e) {
                r.config.title = e,
                ke.setTitle.call(s)
            }),
            r.embed.getCurrentTime().then(function(e) {
                c = e,
                b.call(r, r.media, "timeupdate")
            }),
            r.embed.getDuration().then(function(e) {
                r.media.duration = e,
                b.call(r, r.media, "durationchange")
            }),
            r.embed.getTextTracks().then(function(e) {
                r.media.textTracks = e,
                he.setup.call(r)
            }),
            r.embed.on("cuechange", function(e) {
                var t = e.cues
                ...
                he.updateCues.call(r, n)
            }),
            r.embed.on("loaded", function() {
                (r.embed.getPaused().then(function(e) {
                    $e.call(r, !e),
                    e || b.call(r, r.media, "playing")
                }),
                g.element(r.embed.element) && r.supported.ui) && r.embed.element.setAttribute("tabindex", -1)
            }),
            r.embed.on("play", function() {
                $e.call(r, !0),
                b.call(r, r.media, "playing")
            }),
            r.embed.on("pause", function() {
                $e.call(r, !1)
            }),
            r.embed.on("timeupdate", function(e) {
                r.media.seeking = !1,
                c = e.seconds,
                b.call(r, r.media, "timeupdate")
            }),
            r.embed.on("progress", function(e) {
                r.media.buffered = e.percent,
                b.call(r, r.media, "progress"),
                1 === parseInt(e.percent, 10) && b.call(r, r.media, "canplaythrough"),
                r.embed.getDuration().then(function(e) {
                    e !== r.media.duration && (r.media.duration = e,
                    b.call(r, r.media, "durationchange"))
                })
            }),
            r.embed.on("seeked", function() {
                r.media.seeking = !1,
                b.call(r, r.media, "seeked")
            }),
            r.embed.on("ended", function() {
                r.media.paused = !0,
                b.call(r, r.media, "ended")
            }),
            r.embed.on("error", function(e) {
                r.media.error = e,
                b.call(r, r.media, "error")
            }),
            r.on("enterfullscreen exitfullscreen", function(e) {
                var t = r.fullscreen.target;
                if (t === r.elements.container) {
                    var n = "enterfullscreen" === e.type
                      , i = m(De.ratio.split(":").map(Number), 2)
                      , s = i[0]
                      , o = i[1] < s ? "width" : "height";
                    t.style[o] = n ? "".concat(De.padding, "%") : null
                }
            }),
            setTimeout(function() {
                return ke.build.call(r)
            }, 0)
        }
    };
    function Oe(e) {
    ...
    var Pe, Ne = {
        setup: function() {
            ...
            g.object(window.YT) && g.function(window.YT.Player) ? Ne.ready.call(this) : (Ie(this.config.urls.youtube.sdk).catch(function(e) {
        ...
        getTitle: function(e) {
            ...
            if (g.function(this.embed.getVideoData)) {
                ...
                if (g.empty(n))
                    return this.config.title = n,
                    void ke.setTitle.call(this)
            }
            var i = this.config.keys.google;
            g.string(i) && !g.empty(i) && ie(Y(this.config.urls.youtube.api, e, i)).then(function(e) {
                g.object(e) && (t.config.title = e.items[0].snippet.title,
                ke.setTitle.call(t))
            }).catch(function() {})
        },
        ...
        ready: function() {
            ...
            if (g.empty(e) || !e.startsWith("youtube-")) {
                ...
                g.empty(t) && (t = s.media.getAttribute(this.config.attributes.embed.id));
                var n, i, o = (n = t,
                g.empty(n) ? null : n.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : n), r = (i = s.provider,
                "".concat(i, "-").concat(Math.floor(1e4 * Math.random()))), a = T("div", {
                    id: r,
                    poster: s.poster
                });
                s.media = A(a, s.media);
                ...
                Ee(l("maxres"), 121).catch(function() {
                    return Ee(l("sd"), 121)
                }).catch(function() {
                    return Ee(l("hq"))
                }).then(function(e) {
                    return ke.setPoster.call(s, e.src)
                }).then(function(e) {
                    e.includes("maxres") || (s.elements.poster.style.backgroundSize = "cover")
                }).catch(function() {}),
                s.embed = new window.YT.Player(r,{
                    videoId: o,
                    playerVars: {
                    ...
                    events: {
                        ...
                        onPlaybackRateChange: function(e) {
                            var t = e.target;
                            s.media.playbackRate = t.getPlaybackRate(),
                            b.call(s, s.media, "ratechange")
                        },
                        onReady: function(e) {
                            if (!g.function(s.media.play)) {
                                var n = e.target;
                                Ne.getTitle.call(s, o),
                                ...
                                Object.defineProperty(s.media, "volume", {
                                    ...
                                    set: function(e) {
                                        t = e,
                                        n.setVolume(100 * t),
                                        b.call(s, s.media, "volumechange")
                                    }
                                });
                                var i = s.config.muted;
                                ...
                                s.options.speed = n.getAvailablePlaybackRates(),
                                s.supported.ui && s.media.setAttribute("tabindex", -1),
                                b.call(s, s.media, "timeupdate"),
                                b.call(s, s.media, "durationchange"),
                                clearInterval(s.timers.buffering),
                                s.timers.buffering = setInterval(function() {
                                    s.media.buffered = n.getVideoLoadedFraction(),
                                    (null === s.media.lastBuffered || s.media.lastBuffered < s.media.buffered) && b.call(s, s.media, "progress"),
                                    s.media.lastBuffered = s.media.buffered,
                                    1 === s.media.buffered && (clearInterval(s.timers.buffering),
                                    b.call(s, s.media, "canplaythrough"))
                                }, 200),
                                setTimeout(function() {
                                    return ke.build.call(s)
                                }, 50)
                            }
                        },
                        onStateChange: function(e) {
                            ...
                            b.call(s, s.media, "seeked")),
                            e.data) {
                            case -1:
                                b.call(s, s.media, "timeupdate"),
                                s.media.buffered = t.getVideoLoadedFraction(),
                                b.call(s, s.media, "progress");
                                break;
                            case 0:
                                Oe.call(s, !1),
                                s.media.loop ? (t.stopVideo(),
                                t.playVideo()) : b.call(s, s.media, "ended");
                                break;
                            case 1:
                                s.media.paused && !s.embed.hasPlayed ? s.media.pause() : (Oe.call(s, !0),
                                b.call(s, s.media, "playing"),
                                s.timers.playing = setInterval(function() {
                                    b.call(s, s.media, "timeupdate")
                                }, 50),
        ...
        setup: function() {
            this.media ? ($(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
            $(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0),
            this.isEmbed && $(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0),
            ...
            this.isHTML5 ? W.extend.call(this) : this.isYouTube ? Ne.setup.call(this) : this.isVimeo && De.setup.call(this)) : this.debug.warn("No media element found!")
        }
    }, Le = function() {
        function t(e) {
            var n = this;
            u(this, t),
            this.player = e,
            this.publisherId = e.config.ads.publisherId,
            this.playing = !1,
            this.initialized = !1,
            this.elements = {
                container: null,
        ...
        return e(t, [{
            ...
            value: function() {
                var e = this;
                this.enabled && (g.object(window.google) && g.object(window.google.ima) ? this.ready() : Ie(this.player.config.urls.googleIMA.sdk).then(function() {
                    e.ready()
                }).catch(function() {
            ...
            value: function() {
                ...
                try {
                    ...
                    n.linearAdSlotWidth = e.offsetWidth,
                    n.linearAdSlotHeight = e.offsetHeight,
                    n.nonLinearAdSlotWidth = e.offsetWidth,
                    n.nonLinearAdSlotHeight = e.offsetHeight,
            ...
            value: function() {
                ...
                this.countdownTimer = setInterval(function() {
                    var e = le(Math.max(n.manager.getRemainingTime(), 0))
                      , t = "".concat(te("advertisement", n.player.config), " - ").concat(e);
            ...
            value: function(e) {
                ...
                if (this.enabled) {
                    ...
                    g.empty(this.cuePoints) || this.cuePoints.forEach(function(e) {
                        if (0 !== e && -1 !== e && e < s.player.duration) {
                            var t = s.player.elements.progress;
                            if (g.element(t)) {
                                var n = 100 / s.player.duration * e
                                  , i = T("span", {
                                    class: s.player.config.classNames.cues
                                });
                                i.style.left = "".concat(n.toString(), "%"),
                                t.appendChild(i)
                            }
                        }
                    }),
            ...
            key: "listeners",
            value: function() {
                var i, s = this, e = this.player.elements.container;
                this.player.on("ended", function() {
                    s.loader.contentComplete()
                }),
                this.player.on("seeking", function() {
                    return i = s.player.currentTime
                }),
                this.player.on("seeked", function() {
                    var n = s.player.currentTime;
                    g.empty(s.cuePoints) || s.cuePoints.forEach(function(e, t) {
                        i < e && e < n && (s.manager.discardAdBreak(),
                        s.cuePoints.splice(t, 1))
                    })
                }),
            ...
            key: "trigger",
            value: function(e) {
                for (var t = this, n = arguments.length, i = new Array(1 < n ? n - 1 : 0), s = 1; s < n; s++)
                    i[s - 1] = arguments[s];
                var o = this.events[e];
                g.array(o) && o.forEach(function(e) {
            ...
            key: "on",
            value: function(e, t) {
                return g.array(this.events[e]) || (this.events[e] = []),
            ...
            value: function(e) {
                g.nullOrUndefined(this.safetyTimer) || (this.player.debug.log("Safety timer cleared from: ".concat(e)),
        ...
        change: function(l) {
            var c = this;
            K(l, "sources.length") ? (W.cancelRequests.call(this),
            this.destroy.call(this, function() {
                c.options.quality = [],
                k(c.media),
                c.media = null,
                g.element(c.elements.container) && c.elements.container.removeAttribute("class");
                var e = l.sources
                  , t = l.type
                  , n = m(e, 1)[0]
                  , i = n.provider
                  , s = void 0 === i ? ge.html5 : i
                  , o = n.src
                  , r = "html5" === s ? t : "div"
                  , a = "html5" === s ? {} : {
                    src: o
                ...
                ke.addStyleHook.call(c),
                c.isHTML5 && je.insertElements.call(c, "source", e),
                c.config.title = l.title,
                Me.setup.call(c),
                c.isHTML5 && Object.keys(l).includes("tracks") && je.insertElements.call(c, "track", l.tracks),
                (c.isHTML5 || c.isEmbed && !c.supported.ui) && ke.build.call(c),
        ...
        function c(e, t) {
            ...
            this.config = Q({}, pe, c.defaults, t || {}, function() {
                try {
            ...
            !g.nullOrUndefined(this.media) && g.element(this.media))
                if (this.media.plyr)
                    ...
                    if (U.check().api) {
                        ...
                        var s, o = this.media.tagName.toLowerCase(), r = null, a = null;
                        switch (o) {
                        case "div":
                            if (r = this.media.querySelector("iframe"),
                            g.element(r)) {
                                if (a = ue(r.getAttribute("src")),
                                this.provider = (s = a.toString(),
                                /^(https?:\/\/)?(www\.)?(youtube\.com|youtu\.?be)\/.+$/.test(s) ? ge.youtube : /^https?:\/\/player.vimeo.com\/video\/\d{0,9}(?=\b|\/)/.test(s) ? ge.vimeo : null),
                                this.elements.container = this.media,
                                this.media = r,
                                this.elements.container.className = "",
                                a.search.length) {
                                    var l = ["1", "true"];
                                    l.includes(a.searchParams.get("autoplay")) && (this.config.autoplay = !0),
                                    l.includes(a.searchParams.get("loop")) && (this.config.loop.active = !0),
                                    this.isYouTube ? (this.config.playsinline = l.includes(a.searchParams.get("playsinline")),
                                    this.config.hl = a.searchParams.get("hl")) : this.config.playsinline = !0
                                }
                            } else
                                this.provider = this.media.getAttribute(this.config.attributes.embed.provider),
                                this.media.removeAttribute(this.config.attributes.embed.provider);
                            if (g.empty(this.provider) || !Object.keys(ge).includes(this.provider))
                        ...
                        this.supported = U.check(this.type, this.provider, this.config.playsinline),
                        this.supported.api ? (this.eventListeners = [],
                        this.listeners = new Se(this),
                        this.storage = new ne(this),
                        this.media.plyr = this,
                        g.element(this.elements.container) || (this.elements.container = T("div"),
                        w(this.media, this.elements.container)),
                        ke.addStyleHook.call(this),
                        Me.setup.call(this),
                        this.config.debug && v.call(this, this.elements.container, this.config.events.join(" "), function(e) {
                            n.debug.log("event: ".concat(e.type))
                        }),
                        (this.isHTML5 || this.isEmbed && !this.supported.ui) && ke.build.call(this),
                        this.listeners.container(),
                        this.listeners.global(),
                        this.fullscreen = new Te(this),
                        this.config.ads.enabled && (this.ads = new Le(this)),
                        this.config.autoplay && this.play(),
                        this.lastSeekTime = 0) : this.debug.error("Setup failed: no support")
                    } else
        ...
        return e(c, [{
            ...
            value: function(e) {
                ...
                var t = D(this.elements.container, this.config.classNames.hideControls)
                  , n = void 0 === e ? void 0 : !e
                  , i = $(this.elements.container, this.config.classNames.hideControls, n);
                if (i && this.config.controls.includes("settings") && !g.empty(this.config.settings) && ce.toggleMenu.call(this, !1),
                i !== t) {
                    var s = i ? "controlshidden" : "controlsshown";
            ...
            key: "once",
            value: function(e, t) {
                _.call(this, this.elements.container, e, t)
            }
        }, {
            key: "off",
            value: function(e, t) {
            ...
            value: function(e) {
                ...
                if (this.ready) {
                    var i = function() {
                        ...
                        t.embed = null,
                        n ? (Object.keys(t.elements).length && (k(t.elements.buttons.play),
                        k(t.elements.captions),
                        k(t.elements.controls),
                        k(t.elements.wrapper),
                        t.elements.buttons.play = null,
                        t.elements.captions = null,
                        t.elements.controls = null,
                        t.elements.wrapper = null),
                        g.function(e) && e()) : (function() {
                        ...
                        .call(t),
                        A(t.elements.original, t.elements.container),
                        b.call(t, t.elements.original, "destroyed", !0),
                        g.function(e) && e.call(t.elements.original),
                        t.ready = !1,
                        setTimeout(function() {
                            t.elements = null,
                            t.media = null
                    ...
                    ke.toggleNativeControls.call(this, !0),
                    i()) : this.isYouTube ? (clearInterval(this.timers.buffering),
                    clearInterval(this.timers.playing),
                    null !== this.embed && g.function(this.embed.destroy) && this.embed.destroy(),
            ...
            set: function(e) {
                ...
                g.number(t) || (t = this.config.volume),
                1 < t && (t = 1),
                t < 0 && (t = 0),
                this.config.volume = t,
                this.media.volume = t,
                !g.empty(e) && this.muted && 0 < t && (this.muted = !1)
            },
            get: function() {
            ...
            set: function(e) {
                ...
                this.media.playbackRate = t) : this.debug.warn("Unsupported speed (".concat(t, ")"))
            },
            get: function() {
            ...
            set: function(e) {
                ...
                if (n.length) {
                    var i, s, o = [!g.empty(e) && Number(e), this.storage.get("quality"), t.selected, t.default].find(g.number), r = !0;
                    if (!n.includes(o)) {
                        var a = (i = n,
                        s = o,
                        g.array(i) && i.length ? i.reduce(function(e, t) {
                            return Math.abs(t - s) < Math.abs(e - s) ? t : e
                        }) : null);
                        this.debug.warn("Unsupported quality option: ".concat(o, ", using ").concat(a, " instead")),
                        o = a,
                        r = !1
                    }
                    t.selected = o,
                    this.media.quality = o,
                    r && this.storage.set({
                        quality: o
                    })
                }
            ...
            key: "poster",
            set: function(e) {
                this.isVideo ? ke.setPoster.call(this, e, !1).catch(function() {}) : this.debug.warn("Poster can only be set for video")
            },
            get: function() {
            ...
            set: function(e) {
                if (U.pip) {
                    ...
                    g.function(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? fe : me),
            ...
            get: function() {
                return U.pip ? g.empty(this.media.webkitPresentationMode) ? this.media === document.pictureInPictureElement : this.media.webkitPresentationMode === fe : null
            }
        }], [{
            key: "supported",
            value: function(e, t, n) {
            ...
            value: function(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}
                  , n = null;
                return g.string(e) ? n = Array.from(document.querySelectorAll(e)) : g.nodeList(e) ? n = Array.from(e) : g.array(e) && (n = e.filter(g.element)),
                g.empty(n) ? null : n.map(function(e) {
                    return new c(e,t)
                })
            }
        }]),
...
function() {
    ...
    e.init = function(e) {
        null === e && (e = t);
        var s = e.onload || function() {}
        ;
        e.onload = function() {
            var e, t, n = document.getElementsByTagName("img"), i = [];
            for (e = 0; e < n.length; e += 1)
                (t = n[e]).getAttributeNode("data-no-retina") || i.push(new l(t));
            s()
        }
    }
    ,
    ...
    function a(e, t) {
        ...
        null != t)
            ...
            if (void 0 !== document.createElement) {
                var n = document.createElement("a");
                n.href = this.path,
                n.pathname = n.pathname.replace(o, r),
                this.at_2x_path = n.href
            } else {
                var i = this.path.split("?");
                i[0] = i[0].replace(o, r),
                this.at_2x_path = i.join("?")
            }
    ...
    function l(e) {
        this.el = e,
        this.path = new a(this.el.getAttribute("src"),this.el.getAttribute("data-at2x"));
        var t = this;
        this.path.check_2x_variant(function(e) {
            e && t.swap()
        })
    }
    (t.RetinaImagePath = a).confirmed_paths = [],
    a.prototype.is_external = function() {
        return !(!this.path.match(/^https?\:/i) || this.path.match("//" + document.domain))
    }
    ,
    a.prototype.check_2x_variant = function(t) {
        var n, i = this;
        return this.is_external() ? t(!1) : this.perform_check || void 0 === this.at_2x_path || null === this.at_2x_path ? this.at_2x_path in a.confirmed_paths ? t(!0) : ((n = new XMLHttpRequest).open("HEAD", this.at_2x_path),
        n.onreadystatechange = function() {
            ...
            if (200 <= n.status && n.status <= 399) {
                ...
                return a.confirmed_paths.push(i.at_2x_path),
                t(!0)
            }
            return t(!1)
        }
    ...
    ,
    (t.RetinaImage = l).prototype.swap = function(t) {
        void 0 === t && (t = this.path.at_2x_path);
        var n = this;
        !function e() {
            n.el.complete ? (s.force_original_dimensions && (n.el.setAttribute("width", n.el.offsetWidth),
...
function(n) {
    ...
    var e = function() {
        ...
        var t, s, c;
        return e && e.requirejs || (e ? s = e : e = {},
        function(p) {
            var o, r, f, m, g = {}, v = {}, y = {}, _ = {}, n = Object.prototype.hasOwnProperty, i = [].slice, b = /\.js$/;
            function w(e, t) {
                return n.call(e, t)
            }
            function a(e, t) {
                var n, i, s, o, r, a, l, c, u, d, h, p = t && t.split("/"), f = y.map, m = f && f["*"] || {};
                if (e) {
                    for (r = (e = e.split("/")).length - 1,
                    y.nodeIdCompat && b.test(e[r]) && (e[r] = e[r].replace(b, "")),
            ...
            f = function(e, t) {
                var n, i, s = l(e), o = s[0], r = t[1];
                return e = s[1],
                o && (n = E(o = a(o, r))),
                o ? e = n && n.normalize ? n.normalize(e, (i = r,
                function(e) {
                    return a(e, i)
                }
                )) : a(e, r) : (o = (s = l(e = a(e, r)))[0],
                e = s[1],
                o && (n = E(o))),
                {
                    f: o ? o + "!" + e : e,
            ...
            o = function(e, t, n, i) {
                var s, o, r, a, l, c, u, d = [], h = typeof n;
                if (c = k(i = i || e),
                "undefined" === h || "function" === h) {
                    ...
                    l = 0; l < t.length; l += 1)
                        if ("require" === (o = (a = f(t[l], c)).f))
                            ...
                            s = d[l] = m.module(e);
                        else if (w(g, o) || w(v, o) || w(_, o))
                            d[l] = E(o);
                        else {
                            if (!a.p)
                                throw new Error(e + " missing " + o);
                            a.p.load(a.n, C(i, !0), T(o), {}),
                            d[l] = g[o]
                        }
                    r = n ? n.apply(g[e], d) : void 0,
                    e && (s && s.exports !== p && s.exports !== g[e] ? g[e] = s.exports : r === p && u || (g[e] = r))
                } else
                    e && (g[e] = n)
            }
            ,
            t = s = r = function(e, t, n, i, s) {
                if ("string" == typeof e)
                    return m[e] ? m[e](t) : E(f(e, k(t)).f);
                if (!e.splice) {
                    if ((y = e).deps && r(y.deps, y.callback),
                    !t)
                        return;
                    t.splice ? (e = t,
                    t = n,
                ...
                i = s),
                i ? o(p, e, t, n) : setTimeout(function() {
                    o(p, e, t, n)
                }, 4),
                r
            }
        ...
        e.define("select2/results", ["jquery", "./utils"], function(p, f) {
            function i(e, t, n) {
                this.$element = e,
                this.data = n,
                this.options = t,
            ...
            i.prototype.displayMessage = function(e) {
                ...
                this.clear(),
                this.hideLoading();
                var n = p('<li role="alert" aria-live="assertive" class="select2-results__option"></li>')
            ...
            i.prototype.option = function(e) {
                ...
                for (var s in (null != e.element && i.call(e.element, ":disabled") || null == e.element && e.disabled) && (delete n["aria-selected"],
            ...
            i.prototype.bind = function(t, e) {
                ...
                p.fn.mousewheel && this.$results.on("mousewheel", function(e) {
                    ...
                    e.preventDefault(),
                    e.stopPropagation()) : s && (l.$results.scrollTop(l.$results.get(0).scrollHeight - l.$results.height()),
                    e.preventDefault(),
                    e.stopPropagation())
                }),
            ...
            i.prototype.template = function(e, t) {
                var n = this.options.get("templateResult")
                  ...
                  , s = n(e, t);
                null == s ? t.style.display = "none" : "string" == typeof s ? t.innerHTML = i(s) : p(t).append(s)
            }
            ,
            i
        }),
        ...
        e.define("select2/selection/base", ["jquery", "../utils", "../keys"], function(n, i, s) {
            function o(e, t) {
                this.$element = e,
                this.options = t,
                ...
                0 !== e.length) {
                    for (var t = [], n = 0; n < e.length; n++) {
                        var i = e[n]
                          ...
                          , o = this.display(i, s);
                        s.append(o);
                        var r = i.title || i.text;
                        r && s.attr("title", r),
                        l.StoreData(s[0], "data", i),
                        t.push(s)
                    }
            ...
            return e.prototype.bind = function(e, t, n) {
                ...
                t.on("*", function(e, t) {
                    if (-1 !== r.inArray(e, s)) {
                        ...
                        i.$element.trigger(n),
                        -1 !== r.inArray(e, o) && (t.prevented = n.isDefaultPrevented())
                    }
                })
            }
            ,
        ...
        e.define("select2/data/select", ["./base", "../utils", "jquery"], function(e, a, l) {
            ...
            n.prototype.select = function(s) {
                var o = this;
                if (s.selected = !0,
                l(s.element).is("option"))
                    return s.element.selected = !0,
        ...
        e.define("select2/data/tokenizer", ["jquery"], function(d) {
            ...
            e.prototype.tokenizer = function(e, t, n, i) {
                for (var s = n.get("tokenSeparators") || [], o = t.term, r = 0, a = this.createTag || function(e) {
                    return {
                        id: e.term,
                        text: e.term
                    }
        ...
        e.define("select2/dropdown/attachBody", ["jquery", "../utils"], function(f, a) {
            ...
            e.prototype._positionDropdown = function() {
                ...
                f.contains(document.body, h[0]) && (p = h.offset()),
                d.top -= p.top,
                d.left -= p.left,
                t || n || (i = "below"),
                u || !c || t ? !c && u && t && (i = "below") : i = "above",
                ("above" == i || t && "below" !== i) && (d.top = o.top - p.top - r),
        ...
        e.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function(c, u, d, h, p, f, m, g, v, y, r, t, _, b, w, C, T, E, k, S, A, x, I, $, D, O, P, N, e) {
            ...
            return n.prototype.apply = function(e) {
                ...
                null != e.ajax && (e.resultsAdapter = y.Decorate(e.resultsAdapter, $)),
                null != e.placeholder && (e.resultsAdapter = y.Decorate(e.resultsAdapter, I)),
                e.selectOnClose && (e.resultsAdapter = y.Decorate(e.resultsAdapter, P))),
                null == e.dropdownAdapter) {
                    if (e.multiple)
                        e.dropdownAdapter = A;
                    else {
                        var i = y.Decorate(A, x);
                        e.dropdownAdapter = i
                    }
                    if (0 !== e.minimumResultsForSearch && (e.dropdownAdapter = y.Decorate(e.dropdownAdapter, O)),
                    e.closeOnSelect && (e.dropdownAdapter = y.Decorate(e.dropdownAdapter, N)),
                    null != e.dropdownCssClass || null != e.dropdownCss || null != e.adaptDropdownCssClass) {
                        var s = u(e.amdBase + "compat/dropdownCss");
                        e.dropdownAdapter = y.Decorate(e.dropdownAdapter, s)
                    }
                    e.dropdownAdapter = y.Decorate(e.dropdownAdapter, D)
                }
                if (null == e.selectionAdapter) {
                    if (e.multiple ? e.selectionAdapter = p : e.selectionAdapter = h,
                    null != e.placeholder && (e.selectionAdapter = y.Decorate(e.selectionAdapter, f)),
                    e.allowClear && (e.selectionAdapter = y.Decorate(e.selectionAdapter, m)),
                    e.multiple && (e.selectionAdapter = y.Decorate(e.selectionAdapter, g)),
                ...
                this.defaults = {
                    ...
                    matcher: function e(t, n) {
                        ...
                        if (n.children && 0 < n.children.length) {
                            for (var i = c.extend(!0, {}, n), s = n.children.length - 1; 0 <= s; s--)
            ...
            n.prototype._processTranslations = function(e, t) {
                for (var n = new r, i = 0; i < e.length; i++) {
                    var s = new r
                      , o = e[i];
                    if ("string" == typeof o)
                        try {
        ...
        e.define("select2/options", ["require", "jquery", "./defaults", "./utils"], function(i, u, s, d) {
            function e(e, t) {
                if (this.options = e,
                null != t && this.fromElement(t),
                null != t && (this.options = s.applyFromElement(this.options, t)),
            ...
            return e.prototype.fromElement = function(e) {
                ...
                d.GetData(e[0], "select2Tags") && (this.options.debug && window.console && console.warn && console.warn('Select2: The `data-select2-tags` attribute has been changed to use the `data-data` and `data-tags="true"` attributes and will be removed in future versions of Select2.'),
                d.StoreData(e[0], "data", d.GetData(e[0], "select2Tags")),
                d.StoreData(e[0], "tags", !0)),
                d.GetData(e[0], "ajaxUrl") && (this.options.debug && window.console && console.warn && console.warn("Select2: The `data-ajax-url` attribute has been changed to `data-ajax--url` and support for the old attribute will be removed in future versions of Select2."),
                ...
                for (var s = 0; s < e[0].attributes.length; s++) {
                    ...
                    if ("data-" == o.substr(0, "data-".length)) {
                        var r = o.substring("data-".length)
                          , a = d.GetData(e[0], r);
                        n[r.replace(/-([a-z])/g, i)] = a
                    }
                }
                u.fn.jquery && "1." == u.fn.jquery.substr(0, 2) && e[0].dataset && (n = u.extend(!0, {}, e[0].dataset, n));
                var l = u.extend(!0, {}, d.GetData(e[0]), n);
                for (var c in l = d._convertData(l))
                    -1 < u.inArray(c, t) || (u.isPlainObject(this.options[c]) ? u.extend(this.options[c], l[c]) : this.options[c] = l[c]);
                return this
            }
            ,
        ...
        e.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults", "./select2/utils"], function(s, e, o, t, r) {
            ...
            return null == s.fn.select2.defaults && (s.fn.select2.defaults = t),
            o
        }),
        {
            define: e.define,
